...
func (inst *Wrap) SetTokenConfigAccount(tokenConfig ag_solanago.PublicKey) *Wrap {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(tokenConfig).WRITE()
	return inst
}

func (inst *Wrap) findFindTokenConfigAddress(mint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: token_config
...
func (inst *Wrap) FindTokenConfigAddressWithBumpSeed(mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindTokenConfigAddress(mint, bumpSeed)
	return
}

func (inst *Wrap) MustFindTokenConfigAddressWithBumpSeed(mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindTokenConfigAddress(mint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Wrap) FindTokenConfigAddress(mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindTokenConfigAddress(mint, 0)
	return
}

func (inst *Wrap) MustFindTokenConfigAddress(mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *Wrap) GetTokenConfigAccount() *ag_solanago.AccountMeta {
...
func (inst *Wrap) SetWhitelistedWalletAccount(whitelistedWallet ag_solanago.PublicKey) *Wrap {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(whitelistedWallet).WRITE()
	return inst
}

func (inst *Wrap) findFindWhitelistedWalletAddress(receiver ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *Wrap) FindWhitelistedWalletAddressWithBumpSeed(receiver ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindWhitelistedWalletAddress(receiver, bumpSeed)
	return
}

func (inst *Wrap) MustFindWhitelistedWalletAddressWithBumpSeed(receiver ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindWhitelistedWalletAddress(receiver, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Wrap) FindWhitelistedWalletAddress(receiver ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindWhitelistedWalletAddress(receiver, 0)
	return
}

func (inst *Wrap) MustFindWhitelistedWalletAddress(receiver ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindWhitelistedWalletAddress(receiver, 0)
	if err != nil {
		panic(err)
	}
	return
...
func (inst *Wrap) GetWhitelistedWalletAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("Wrap")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=12]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      whitelisted_wallet", inst.AccountMetaSlice.Get(8)))
