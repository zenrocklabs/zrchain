...
type Unwrap struct {
	...
	// [4] = [WRITE] signer_ata
	//
	// [5] = [WRITE] whitelisted_wallet
	//
	// [6] = [WRITE] fee_wallet
	//
	// [7] = [WRITE] fee_wallet_ata
	//
	// [8] = [] system_program
	//
	// [9] = [] token_program
...
func (inst *Unwrap) SetTokenConfigAccount(tokenConfig ag_solanago.PublicKey) *Unwrap {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(tokenConfig).WRITE()
	return inst
}

func (inst *Unwrap) findFindTokenConfigAddress(mint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: token_config
...
func (inst *Unwrap) FindTokenConfigAddressWithBumpSeed(mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindTokenConfigAddress(mint, bumpSeed)
	return
}

func (inst *Unwrap) MustFindTokenConfigAddressWithBumpSeed(mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindTokenConfigAddress(mint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Unwrap) FindTokenConfigAddress(mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindTokenConfigAddress(mint, 0)
	return
}

func (inst *Unwrap) MustFindTokenConfigAddress(mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *Unwrap) GetTokenConfigAccount() *ag_solanago.AccountMeta {
...
// SetWhitelistedWalletAccount sets the "whitelisted_wallet" account.
func (inst *Unwrap) SetWhitelistedWalletAccount(whitelistedWallet ag_solanago.PublicKey) *Unwrap {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(whitelistedWallet).WRITE()
	return inst
}

func (inst *Unwrap) findFindWhitelistedWalletAddress(signer ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: whitelisted_wallet
	seeds = append(seeds, []byte{byte(0x77), byte(0x68), byte(0x69), byte(0x74), byte(0x65), byte(0x6c), byte(0x69), byte(0x73), byte(0x74), byte(0x65), byte(0x64), byte(0x5f), byte(0x77), byte(0x61), byte(0x6c), byte(0x6c), byte(0x65), byte(0x74)})
	// path: signer
	seeds = append(seeds, signer.Bytes())
...
// FindWhitelistedWalletAddressWithBumpSeed calculates WhitelistedWallet account address with given seeds and a known bump seed.
func (inst *Unwrap) FindWhitelistedWalletAddressWithBumpSeed(signer ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindWhitelistedWalletAddress(signer, bumpSeed)
	return
}

func (inst *Unwrap) MustFindWhitelistedWalletAddressWithBumpSeed(signer ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindWhitelistedWalletAddress(signer, bumpSeed)
	if err != nil {
		panic(err)
	}
...
// FindWhitelistedWalletAddress finds WhitelistedWallet account address with given seeds.
func (inst *Unwrap) FindWhitelistedWalletAddress(signer ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindWhitelistedWalletAddress(signer, 0)
	return
}

func (inst *Unwrap) MustFindWhitelistedWalletAddress(signer ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindWhitelistedWalletAddress(signer, 0)
	if err != nil {
		panic(err)
	}
	return
...
// GetWhitelistedWalletAccount gets the "whitelisted_wallet" account.
func (inst *Unwrap) GetWhitelistedWalletAccount() *ag_solanago.AccountMeta {
...
func (inst *Unwrap) SetFeeWalletAccount(feeWallet ag_solanago.PublicKey) *Unwrap {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(feeWallet).WRITE()
	return inst
}
...
func (inst *Unwrap) SetFeeWalletAtaAccount(feeWalletAta ag_solanago.PublicKey) *Unwrap {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(feeWalletAta).WRITE()
	return inst
}
...
func (inst *Unwrap) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		if inst.AccountMetaSlice[5] == nil {
			return errors.New("accounts.WhitelistedWallet is not set")
		}
			...
			programBranch.Child(ag_format.Instruction("Unwrap")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=11]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("      whitelisted_wallet", inst.AccountMetaSlice.Get(5)))
						accountsBranch.Child(ag_format.Meta("              fee_wallet", inst.AccountMetaSlice.Get(6)))
						accountsBranch.Child(ag_format.Meta("          fee_wallet_ata", inst.AccountMetaSlice.Get(7)))
...
func NewUnwrapInstruction(
	...
	whitelistedWallet ag_solanago.PublicKey,
	...
	return NewUnwrapInstructionBuilder().
		...
		SetWhitelistedWalletAccount(whitelistedWallet).
