...
// UpdateFeeWallet is the `update_fee_wallet` instruction.
...
func (inst *UpdateFeeWallet) SetTokenConfigAccount(tokenConfig ag_solanago.PublicKey) *UpdateFeeWallet {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(tokenConfig).WRITE()
	return inst
}

func (inst *UpdateFeeWallet) findFindTokenConfigAddress(mint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: token_config
...
func (inst *UpdateFeeWallet) FindTokenConfigAddressWithBumpSeed(mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindTokenConfigAddress(mint, bumpSeed)
	return
}

func (inst *UpdateFeeWallet) MustFindTokenConfigAddressWithBumpSeed(mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindTokenConfigAddress(mint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *UpdateFeeWallet) FindTokenConfigAddress(mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindTokenConfigAddress(mint, 0)
	return
}

func (inst *UpdateFeeWallet) MustFindTokenConfigAddress(mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *UpdateFeeWallet) GetTokenConfigAccount() *ag_solanago.AccountMeta {
