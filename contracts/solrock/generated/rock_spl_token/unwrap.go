...
type Unwrap struct {
	...
	//
	// [3] = [WRITE] signer_ata
	// ··········· Signer's token account to burn from
	//
	// [4] = [WRITE] fee_wallet
	// ··········· Fee wallet that receives burn fees
	//
...
func (inst *Unwrap) SetSignerAtaAccount(signerAta ag_solanago.PublicKey) *Unwrap {
	inst.AccountMetaSlice[3] = ag_solanago.Meta(signerAta).WRITE()
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("Unwrap")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=9]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("              signer_ata", inst.AccountMetaSlice.Get(3)))
