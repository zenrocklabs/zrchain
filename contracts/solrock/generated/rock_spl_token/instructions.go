// Main program module that implements wrapped token functionality with authority and fee management
...
const ProgramName = "RockSplToken"
...
var (
	...
	// Burn (unwrap) tokens and record destination address
	// Takes burn fee that goes to fee wallet
