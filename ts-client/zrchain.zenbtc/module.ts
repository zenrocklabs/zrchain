...
export { MsgVerifyDepositBlockInclusion, QueryRedemptionsRequest, QuerySupplyRequest, Redemption, MsgUpdateParamsResponse, InputHashes, QueryLockTransactionsResponse, QueryPendingMintTransactionsResponse, QueryPendingMintTransactionResponse, QueryBurnEventsResponse, GenesisState, RedemptionData, MsgVerifyDepositBlockInclusionResponse, QueryParamsResponse, QueryBurnEventsRequest, NonceData, RequestedBitcoinHeaders, LockTransaction, MsgSubmitUnsignedRedemptionTx, Solana, MsgSubmitUnsignedRedemptionTxResponse, QueryPendingMintTransactionsRequest, PendingMintTransaction, PendingMintTransactions, Params, QueryLockTransactionsRequest, BurnEvent, MsgUpdateParams, QueryRedemptionsResponse, QuerySupplyResponse, Supply, QueryParamsRequest, QueryPendingMintTransactionRequest };
...
type sendQueryPendingMintTransactionResponseParams = {
  value: QueryPendingMintTransactionResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryPendingMintTransactionRequestParams = {
  value: QueryPendingMintTransactionRequest,
  fee?: StdFee,
  memo?: string
};
...
type queryPendingMintTransactionResponseParams = {
  value: QueryPendingMintTransactionResponse,
};
...
type queryPendingMintTransactionRequestParams = {
  value: QueryPendingMintTransactionRequest,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendQueryPendingMintTransactionResponse({ value, fee, memo }: sendQueryPendingMintTransactionResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryPendingMintTransactionResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryPendingMintTransactionResponse({ value: QueryPendingMintTransactionResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryPendingMintTransactionResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryPendingMintTransactionRequest({ value, fee, memo }: sendQueryPendingMintTransactionRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryPendingMintTransactionRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryPendingMintTransactionRequest({ value: QueryPendingMintTransactionRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryPendingMintTransactionRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		queryPendingMintTransactionResponse({ value }: queryPendingMintTransactionResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.zenbtc.QueryPendingMintTransactionResponse", value: QueryPendingMintTransactionResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryPendingMintTransactionResponse: Could not create message: ' + e.message)
			}
		},
		...
		queryPendingMintTransactionRequest({ value }: queryPendingMintTransactionRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.zenbtc.QueryPendingMintTransactionRequest", value: QueryPendingMintTransactionRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryPendingMintTransactionRequest: Could not create message: ' + e.message)
			}
		},
