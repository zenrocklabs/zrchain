...
export { QueryInflationResponse, QueryAnnualProvisionsRequest, GenesisState, Minter, QueryParamsResponse, QueryInflationRequest, Params, MsgUpdateParams, MsgUpdateParamsResponse, QueryParamsRequest, QueryAnnualProvisionsResponse };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		queryInflationResponse({ value }: queryInflationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.QueryInflationResponse", value: QueryInflationResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryAnnualProvisionsRequest({ value }: queryAnnualProvisionsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.QueryAnnualProvisionsRequest", value: QueryAnnualProvisionsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		genesisState({ value }: genesisStateParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.GenesisState", value: GenesisState.fromPartial( value ) }  
			} catch (e: any) {
		...
		minter({ value }: minterParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.Minter", value: Minter.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsResponse({ value }: queryParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.QueryParamsResponse", value: QueryParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryInflationRequest({ value }: queryInflationRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.QueryInflationRequest", value: QueryInflationRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		params({ value }: paramsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.Params", value: Params.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParams({ value }: msgUpdateParamsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.MsgUpdateParams", value: MsgUpdateParams.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParamsResponse({ value }: msgUpdateParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.MsgUpdateParamsResponse", value: MsgUpdateParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsRequest({ value }: queryParamsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.QueryParamsRequest", value: QueryParamsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryAnnualProvisionsResponse({ value }: queryAnnualProvisionsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.mint.v1beta1.QueryAnnualProvisionsResponse", value: QueryAnnualProvisionsResponse.fromPartial( value ) }  
			} catch (e: any) {
...
const IgntModule = (test: IgniteClient) => {
	return {
		module: {
			ZrchainMintV1Beta1: new SDKModule(test)
		},
		registry: msgTypes
  }
}
