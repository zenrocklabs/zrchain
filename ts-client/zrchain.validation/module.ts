...
import { AssetData as typeAssetData} from "./types"
...
import { ValidatorHV as typeValidatorHV} from "./types"
import { HistoricalInfoHV as typeHistoricalInfoHV} from "./types"
import { SlashEvent as typeSlashEvent} from "./types"
import { HVParams as typeHVParams} from "./types"
import { ValidationInfo as typeValidationInfo} from "./types"
import { ValidatorPower as typeValidatorPower} from "./types"
import { SolanaNonce as typeSolanaNonce} from "./types"
...
import { BackfillRequests as typeBackfillRequests} from "./types"

export { ValidatorHV, Pool, HVParams, QueryValidatorsRequest, QueryValidatorUnbondingDelegationsResponse, QueryPowerResponse, RedelegationEntryResponse, GenesisState, QueryUnbondingDelegationResponse, QueryDelegatorUnbondingDelegationsResponse, QueryDelegatorValidatorsResponse, QueryPoolResponse, QueryHistoricalInfoResponse, CommissionRates, QueryValidatorResponse, QueryHistoricalInfoRequest, QueryPoolRequest, ValAddresses, LastValidatorPower, QueryValidatorUnbondingDelegationsRequest, QueryDelegatorDelegationsResponse, UnbondingDelegationEntry, AssetData, MsgDelegate, QueryDelegatorValidatorsRequest, QueryDelegatorValidatorResponse, DVPair, MsgCancelUnbondingDelegationResponse, MsgUpdateParamsResponse, QueryDelegationResponse, QueryUnbondingDelegationRequest, QueryParamsRequest, StakeAuthorization_Validators, MsgCreateValidator, SlashEvent, MsgEditValidator, MsgCancelUnbondingDelegation, QueryValidatorsResponse, QueryValidatorRequest, QueryRedelegationsResponse, QueryPowerRequest, ValidationInfo, MsgCreateValidatorResponse, MsgTriggerEventBackfillResponse, QueryDelegationRequest, QueryDelegatorUnbondingDelegationsRequest, QueryBackfillRequestsRequest, Description, Params, MsgUpdateParams, BackfillRequests, QueryDelegatorValidatorRequest, DVPairs, DVVTriplet, RedelegationEntry, MsgBeginRedelegateResponse, MsgUpdateHVParams, Commission, QueryDelegatorDelegationsRequest, DelegationResponse, RedelegationResponse, MsgDelegateResponse, MsgUndelegate, QueryValidatorDelegationsRequest, ValidatorPower, SolanaNonce, StakeAuthorization, QueryParamsResponse, QueryBackfillRequestsResponse, Delegation, UnbondingDelegation, Redelegation, ValidatorUpdates, HistoricalInfoHV, MsgUndelegateResponse, QueryValidatorDelegationsResponse, QueryRedelegationsRequest, MsgEditValidatorResponse, MsgBeginRedelegate, MsgUpdateHVParamsResponse, MsgTriggerEventBackfill, DVVTriplets };

type sendValidatorHVParams = {
  value: ValidatorHV,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryPowerResponseParams = {
  value: QueryPowerResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryPowerRequestParams = {
  value: QueryPowerRequest,
  fee?: StdFee,
  memo?: string
};

type sendValidationInfoParams = {
...
type sendMsgTriggerEventBackfillResponseParams = {
  value: MsgTriggerEventBackfillResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryBackfillRequestsRequestParams = {
  value: QueryBackfillRequestsRequest,
  fee?: StdFee,
  memo?: string
};
...
type sendBackfillRequestsParams = {
  value: BackfillRequests,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgUpdateHVParamsParams = {
  value: MsgUpdateHVParams,
  fee?: StdFee,
  memo?: string
};
...
type sendValidatorPowerParams = {
  value: ValidatorPower,
  fee?: StdFee,
  memo?: string
};

type sendSolanaNonceParams = {
  value: SolanaNonce,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryBackfillRequestsResponseParams = {
  value: QueryBackfillRequestsResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendHistoricalInfoHVParams = {
  value: HistoricalInfoHV,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgUpdateHVParamsResponseParams = {
  value: MsgUpdateHVParamsResponse,
  fee?: StdFee,
  memo?: string
};

type sendMsgTriggerEventBackfillParams = {
  value: MsgTriggerEventBackfill,
  fee?: StdFee,
  memo?: string
};
...
type queryPowerRequestParams = {
  value: QueryPowerRequest,
};

type validationInfoParams = {
  value: ValidationInfo,
};
...
type msgTriggerEventBackfillResponseParams = {
  value: MsgTriggerEventBackfillResponse,
};
...
type queryBackfillRequestsRequestParams = {
  value: QueryBackfillRequestsRequest,
};
...
type validatorPowerParams = {
  value: ValidatorPower,
};

type solanaNonceParams = {
  value: SolanaNonce,
};
...
type queryBackfillRequestsResponseParams = {
  value: QueryBackfillRequestsResponse,
};
...
type msgUpdateHvparamsResponseParams = {
  value: MsgUpdateHVParamsResponse,
};

type msgTriggerEventBackfillParams = {
  value: MsgTriggerEventBackfill,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendValidatorHV({ value, fee, memo }: sendValidatorHVParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendValidatorHV: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.validatorHv({ value: ValidatorHV.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendValidatorHV: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendHVParams({ value, fee, memo }: sendHVParamsParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendHVParams: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.hvparams({ value: HVParams.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendHVParams: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryPowerResponse({ value, fee, memo }: sendQueryPowerResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryPowerResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryPowerResponse({ value: QueryPowerResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryPowerResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendAssetData({ value, fee, memo }: sendAssetDataParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendAssetData: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.assetData({ value: AssetData.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendAssetData: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendSlashEvent({ value, fee, memo }: sendSlashEventParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendSlashEvent: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.slashEvent({ value: SlashEvent.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendSlashEvent: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryPowerRequest({ value, fee, memo }: sendQueryPowerRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryPowerRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryPowerRequest({ value: QueryPowerRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryPowerRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		
		async sendValidationInfo({ value, fee, memo }: sendValidationInfoParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendValidationInfo: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.validationInfo({ value: ValidationInfo.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendValidationInfo: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgTriggerEventBackfillResponse({ value, fee, memo }: sendMsgTriggerEventBackfillResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgTriggerEventBackfillResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgTriggerEventBackfillResponse({ value: MsgTriggerEventBackfillResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgTriggerEventBackfillResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryBackfillRequestsRequest({ value, fee, memo }: sendQueryBackfillRequestsRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryBackfillRequestsRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryBackfillRequestsRequest({ value: QueryBackfillRequestsRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryBackfillRequestsRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendBackfillRequests({ value, fee, memo }: sendBackfillRequestsParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendBackfillRequests: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.backfillRequests({ value: BackfillRequests.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendBackfillRequests: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgUpdateHVParams({ value, fee, memo }: sendMsgUpdateHVParamsParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgUpdateHVParams: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgUpdateHvparams({ value: MsgUpdateHVParams.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgUpdateHVParams: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendValidatorPower({ value, fee, memo }: sendValidatorPowerParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendValidatorPower: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.validatorPower({ value: ValidatorPower.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendValidatorPower: Could not broadcast Tx: '+ e.message)
			}
		},
		
		async sendSolanaNonce({ value, fee, memo }: sendSolanaNonceParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendSolanaNonce: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.solanaNonce({ value: SolanaNonce.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendSolanaNonce: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryBackfillRequestsResponse({ value, fee, memo }: sendQueryBackfillRequestsResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryBackfillRequestsResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryBackfillRequestsResponse({ value: QueryBackfillRequestsResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryBackfillRequestsResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendHistoricalInfoHV({ value, fee, memo }: sendHistoricalInfoHVParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendHistoricalInfoHV: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.historicalInfoHv({ value: HistoricalInfoHV.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendHistoricalInfoHV: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgUpdateHVParamsResponse({ value, fee, memo }: sendMsgUpdateHVParamsResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgUpdateHVParamsResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgUpdateHvparamsResponse({ value: MsgUpdateHVParamsResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgUpdateHVParamsResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		
		async sendMsgTriggerEventBackfill({ value, fee, memo }: sendMsgTriggerEventBackfillParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgTriggerEventBackfill: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgTriggerEventBackfill({ value: MsgTriggerEventBackfill.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgTriggerEventBackfill: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		validatorHv({ value }: validatorHvParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.ValidatorHV", value: ValidatorHV.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:ValidatorHV: Could not create message: ' + e.message)
			}
		},
		
		pool({ value }: poolParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.Pool", value: Pool.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:Pool: Could not create message: ' + e.message)
			}
		},
		
		hvparams({ value }: hvparamsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.HVParams", value: HVParams.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:HVParams: Could not create message: ' + e.message)
			}
		},
		
		queryValidatorsRequest({ value }: queryValidatorsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorsRequest", value: QueryValidatorsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorUnbondingDelegationsResponse({ value }: queryValidatorUnbondingDelegationsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorUnbondingDelegationsResponse", value: QueryValidatorUnbondingDelegationsResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryValidatorUnbondingDelegationsResponse: Could not create message: ' + e.message)
			}
		},
		
		queryPowerResponse({ value }: queryPowerResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryPowerResponse", value: QueryPowerResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryPowerResponse: Could not create message: ' + e.message)
			}
		},
		
		redelegationEntryResponse({ value }: redelegationEntryResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.RedelegationEntryResponse", value: RedelegationEntryResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		genesisState({ value }: genesisStateParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.GenesisState", value: GenesisState.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryUnbondingDelegationResponse({ value }: queryUnbondingDelegationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryUnbondingDelegationResponse", value: QueryUnbondingDelegationResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorUnbondingDelegationsResponse({ value }: queryDelegatorUnbondingDelegationsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorUnbondingDelegationsResponse", value: QueryDelegatorUnbondingDelegationsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorValidatorsResponse({ value }: queryDelegatorValidatorsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorValidatorsResponse", value: QueryDelegatorValidatorsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryPoolResponse({ value }: queryPoolResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryPoolResponse", value: QueryPoolResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryHistoricalInfoResponse({ value }: queryHistoricalInfoResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryHistoricalInfoResponse", value: QueryHistoricalInfoResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		commissionRates({ value }: commissionRatesParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.CommissionRates", value: CommissionRates.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorResponse({ value }: queryValidatorResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorResponse", value: QueryValidatorResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryHistoricalInfoRequest({ value }: queryHistoricalInfoRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryHistoricalInfoRequest", value: QueryHistoricalInfoRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryPoolRequest({ value }: queryPoolRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryPoolRequest", value: QueryPoolRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		valAddresses({ value }: valAddressesParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.ValAddresses", value: ValAddresses.fromPartial( value ) }  
			} catch (e: any) {
		...
		lastValidatorPower({ value }: lastValidatorPowerParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.LastValidatorPower", value: LastValidatorPower.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorUnbondingDelegationsRequest({ value }: queryValidatorUnbondingDelegationsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorUnbondingDelegationsRequest", value: QueryValidatorUnbondingDelegationsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorDelegationsResponse({ value }: queryDelegatorDelegationsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorDelegationsResponse", value: QueryDelegatorDelegationsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		unbondingDelegationEntry({ value }: unbondingDelegationEntryParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.UnbondingDelegationEntry", value: UnbondingDelegationEntry.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:UnbondingDelegationEntry: Could not create message: ' + e.message)
			}
		},
		
		assetData({ value }: assetDataParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.AssetData", value: AssetData.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:AssetData: Could not create message: ' + e.message)
			}
		},
		
		msgDelegate({ value }: msgDelegateParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgDelegate", value: MsgDelegate.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorValidatorsRequest({ value }: queryDelegatorValidatorsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorValidatorsRequest", value: QueryDelegatorValidatorsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorValidatorResponse({ value }: queryDelegatorValidatorResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorValidatorResponse", value: QueryDelegatorValidatorResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		dvpair({ value }: dvpairParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.DVPair", value: DVPair.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCancelUnbondingDelegationResponse({ value }: msgCancelUnbondingDelegationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgCancelUnbondingDelegationResponse", value: MsgCancelUnbondingDelegationResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParamsResponse({ value }: msgUpdateParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgUpdateParamsResponse", value: MsgUpdateParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegationResponse({ value }: queryDelegationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegationResponse", value: QueryDelegationResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryUnbondingDelegationRequest({ value }: queryUnbondingDelegationRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryUnbondingDelegationRequest", value: QueryUnbondingDelegationRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsRequest({ value }: queryParamsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryParamsRequest", value: QueryParamsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		stakeAuthorizationValidators({ value }: stakeAuthorizationValidatorsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.StakeAuthorization_Validators", value: StakeAuthorization_Validators.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateValidator({ value }: msgCreateValidatorParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgCreateValidator", value: MsgCreateValidator.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgCreateValidator: Could not create message: ' + e.message)
			}
		},
		
		slashEvent({ value }: slashEventParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.SlashEvent", value: SlashEvent.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:SlashEvent: Could not create message: ' + e.message)
			}
		},
		
		msgEditValidator({ value }: msgEditValidatorParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgEditValidator", value: MsgEditValidator.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCancelUnbondingDelegation({ value }: msgCancelUnbondingDelegationParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgCancelUnbondingDelegation", value: MsgCancelUnbondingDelegation.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorsResponse({ value }: queryValidatorsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorsResponse", value: QueryValidatorsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorRequest({ value }: queryValidatorRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorRequest", value: QueryValidatorRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryRedelegationsResponse({ value }: queryRedelegationsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryRedelegationsResponse", value: QueryRedelegationsResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryRedelegationsResponse: Could not create message: ' + e.message)
			}
		},
		
		queryPowerRequest({ value }: queryPowerRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryPowerRequest", value: QueryPowerRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryPowerRequest: Could not create message: ' + e.message)
			}
		},
		
		validationInfo({ value }: validationInfoParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.ValidationInfo", value: ValidationInfo.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:ValidationInfo: Could not create message: ' + e.message)
			}
		},
		
		msgCreateValidatorResponse({ value }: msgCreateValidatorResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgCreateValidatorResponse", value: MsgCreateValidatorResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgCreateValidatorResponse: Could not create message: ' + e.message)
			}
		},
		
		msgTriggerEventBackfillResponse({ value }: msgTriggerEventBackfillResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgTriggerEventBackfillResponse", value: MsgTriggerEventBackfillResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgTriggerEventBackfillResponse: Could not create message: ' + e.message)
			}
		},
		
		queryDelegationRequest({ value }: queryDelegationRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegationRequest", value: QueryDelegationRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorUnbondingDelegationsRequest({ value }: queryDelegatorUnbondingDelegationsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorUnbondingDelegationsRequest", value: QueryDelegatorUnbondingDelegationsRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryDelegatorUnbondingDelegationsRequest: Could not create message: ' + e.message)
			}
		},
		
		queryBackfillRequestsRequest({ value }: queryBackfillRequestsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryBackfillRequestsRequest", value: QueryBackfillRequestsRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryBackfillRequestsRequest: Could not create message: ' + e.message)
			}
		},
		
		description({ value }: descriptionParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.Description", value: Description.fromPartial( value ) }  
			} catch (e: any) {
		...
		params({ value }: paramsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.Params", value: Params.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParams({ value }: msgUpdateParamsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgUpdateParams", value: MsgUpdateParams.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgUpdateParams: Could not create message: ' + e.message)
			}
		},
		
		backfillRequests({ value }: backfillRequestsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.BackfillRequests", value: BackfillRequests.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:BackfillRequests: Could not create message: ' + e.message)
			}
		},
		
		queryDelegatorValidatorRequest({ value }: queryDelegatorValidatorRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorValidatorRequest", value: QueryDelegatorValidatorRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		dvpairs({ value }: dvpairsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.DVPairs", value: DVPairs.fromPartial( value ) }  
			} catch (e: any) {
		...
		dvvtriplet({ value }: dvvtripletParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.DVVTriplet", value: DVVTriplet.fromPartial( value ) }  
			} catch (e: any) {
		...
		redelegationEntry({ value }: redelegationEntryParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.RedelegationEntry", value: RedelegationEntry.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgBeginRedelegateResponse({ value }: msgBeginRedelegateResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgBeginRedelegateResponse", value: MsgBeginRedelegateResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgBeginRedelegateResponse: Could not create message: ' + e.message)
			}
		},
		
		msgUpdateHvparams({ value }: msgUpdateHvparamsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgUpdateHVParams", value: MsgUpdateHVParams.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgUpdateHVParams: Could not create message: ' + e.message)
			}
		},
		
		commission({ value }: commissionParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.Commission", value: Commission.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryDelegatorDelegationsRequest({ value }: queryDelegatorDelegationsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryDelegatorDelegationsRequest", value: QueryDelegatorDelegationsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		delegationResponse({ value }: delegationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.DelegationResponse", value: DelegationResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		redelegationResponse({ value }: redelegationResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.RedelegationResponse", value: RedelegationResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDelegateResponse({ value }: msgDelegateResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgDelegateResponse", value: MsgDelegateResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUndelegate({ value }: msgUndelegateParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgUndelegate", value: MsgUndelegate.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorDelegationsRequest({ value }: queryValidatorDelegationsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorDelegationsRequest", value: QueryValidatorDelegationsRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryValidatorDelegationsRequest: Could not create message: ' + e.message)
			}
		},
		
		validatorPower({ value }: validatorPowerParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.ValidatorPower", value: ValidatorPower.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:ValidatorPower: Could not create message: ' + e.message)
			}
		},
		
		solanaNonce({ value }: solanaNonceParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.SolanaNonce", value: SolanaNonce.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:SolanaNonce: Could not create message: ' + e.message)
			}
		},
		
		stakeAuthorization({ value }: stakeAuthorizationParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.StakeAuthorization", value: StakeAuthorization.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsResponse({ value }: queryParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryParamsResponse", value: QueryParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryParamsResponse: Could not create message: ' + e.message)
			}
		},
		
		queryBackfillRequestsResponse({ value }: queryBackfillRequestsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryBackfillRequestsResponse", value: QueryBackfillRequestsResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryBackfillRequestsResponse: Could not create message: ' + e.message)
			}
		},
		
		delegation({ value }: delegationParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.Delegation", value: Delegation.fromPartial( value ) }  
			} catch (e: any) {
		...
		unbondingDelegation({ value }: unbondingDelegationParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.UnbondingDelegation", value: UnbondingDelegation.fromPartial( value ) }  
			} catch (e: any) {
		...
		redelegation({ value }: redelegationParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.Redelegation", value: Redelegation.fromPartial( value ) }  
			} catch (e: any) {
		...
		validatorUpdates({ value }: validatorUpdatesParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.ValidatorUpdates", value: ValidatorUpdates.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:ValidatorUpdates: Could not create message: ' + e.message)
			}
		},
		
		historicalInfoHv({ value }: historicalInfoHvParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.HistoricalInfoHV", value: HistoricalInfoHV.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:HistoricalInfoHV: Could not create message: ' + e.message)
			}
		},
		
		msgUndelegateResponse({ value }: msgUndelegateResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgUndelegateResponse", value: MsgUndelegateResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryValidatorDelegationsResponse({ value }: queryValidatorDelegationsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryValidatorDelegationsResponse", value: QueryValidatorDelegationsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryRedelegationsRequest({ value }: queryRedelegationsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.QueryRedelegationsRequest", value: QueryRedelegationsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgEditValidatorResponse({ value }: msgEditValidatorResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgEditValidatorResponse", value: MsgEditValidatorResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgBeginRedelegate({ value }: msgBeginRedelegateParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgBeginRedelegate", value: MsgBeginRedelegate.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgBeginRedelegate: Could not create message: ' + e.message)
			}
		},
		
		msgUpdateHvparamsResponse({ value }: msgUpdateHvparamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgUpdateHVParamsResponse", value: MsgUpdateHVParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgUpdateHVParamsResponse: Could not create message: ' + e.message)
			}
		},
		
		msgTriggerEventBackfill({ value }: msgTriggerEventBackfillParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.MsgTriggerEventBackfill", value: MsgTriggerEventBackfill.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgTriggerEventBackfill: Could not create message: ' + e.message)
			}
		},
		
		dvvtriplets({ value }: dvvtripletsParams): EncodeObject {
			try {
				return { typeUrl: "/zrchain.validation.DVVTriplets", value: DVVTriplets.fromPartial( value ) }  
			} catch (e: any) {
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						AssetData: getStructure(typeAssetData.fromPartial({})),
						...
						ValidatorHV: getStructure(typeValidatorHV.fromPartial({})),
						HistoricalInfoHV: getStructure(typeHistoricalInfoHV.fromPartial({})),
						SlashEvent: getStructure(typeSlashEvent.fromPartial({})),
						HVParams: getStructure(typeHVParams.fromPartial({})),
						ValidationInfo: getStructure(typeValidationInfo.fromPartial({})),
						ValidatorPower: getStructure(typeValidatorPower.fromPartial({})),
						SolanaNonce: getStructure(typeSolanaNonce.fromPartial({})),
						...
						BackfillRequests: getStructure(typeBackfillRequests.fromPartial({})),
...
const IgntModule = (test: IgniteClient) => {
	return {
		module: {
			ZrchainValidation: new SDKModule(test)
		},
		registry: msgTypes
  }
}
