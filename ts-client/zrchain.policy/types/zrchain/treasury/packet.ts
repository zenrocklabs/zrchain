...
export interface TreasuryPacketData {
...
function createBaseTreasuryPacketData(): TreasuryPacketData {
  return { noData: undefined };
}

export const TreasuryPacketData: MessageFns<TreasuryPacketData> = {
  encode(message: TreasuryPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TreasuryPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTreasuryPacketData();
  ...
  fromJSON(object: any): TreasuryPacketData {
    return { noData: isSet(object.noData) ? NoData.fromJSON(object.noData) : undefined };
  },

  toJSON(message: TreasuryPacketData): unknown {
    const obj: any = {};
    if (message.noData !== undefined) {
  ...
  create<I extends Exact<DeepPartial<TreasuryPacketData>, I>>(base?: I): TreasuryPacketData {
    return TreasuryPacketData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<TreasuryPacketData>, I>>(object: I): TreasuryPacketData {
    const message = createBaseTreasuryPacketData();
