...
function createBaseQueryMintsRequest(): QueryMintsRequest {
  return { id: 0, creator: "", status: 0, denom: "", pagination: undefined, txId: 0, sourceTxHash: "" };
}
...
export const QueryMintsRequest: MessageFns<QueryMintsRequest> = {
  encode(message: QueryMintsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sourceTxHash !== "") {
      writer.uint32(58).string(message.sourceTxHash);
    }
    return writer;
  },
  ...
  fromJSON(object: any): QueryMintsRequest {
    return {
      ...
      sourceTxHash: isSet(object.sourceTxHash) ? globalThis.String(object.sourceTxHash) : "",
    };
  },
...
function createBaseQueryBurnsRequest(): QueryBurnsRequest {
  return { id: 0, denom: "", status: 0, txId: 0, recipientAddress: "", sourceTxHash: "", pagination: undefined };
}
...
export const QueryBurnsRequest: MessageFns<QueryBurnsRequest> = {
  encode(message: QueryBurnsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.txId !== 0) {
      writer.uint32(32).uint64(message.txId);
    }
    if (message.recipientAddress !== "") {
      writer.uint32(42).string(message.recipientAddress);
    }
    if (message.sourceTxHash !== "") {
      writer.uint32(50).string(message.sourceTxHash);
    }
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(58).fork()).join();
    }
    return writer;
  },
