...
import { HistoricalInfoHV, HVParams, ValidatorHV } from "./hybrid_validation";
import {
  BondStatus,
  bondStatusFromJSON,
  bondStatusToJSON,
...
export interface QueryValidatorResponse {
  ...
  validator: ValidatorHV | undefined;
}
...
export interface QueryHistoricalInfoResponse {
  ...
  hist: HistoricalInfoHV | undefined;
}
 ...
 * method.
 */
export interface QueryPowerRequest {
}
 ...
 * method.
 */
export interface QueryPowerResponse {
 ...
 */
export interface QueryBackfillRequestsRequest {
}
 ...
 * Query/BackfillRequests RPC method.
 */
export interface QueryBackfillRequestsResponse {
  /** backfill_requests contains the list of backfill requests. */
  backfillRequests: BackfillRequests | undefined;
}
...
export const QueryValidatorsResponse: MessageFns<QueryValidatorsResponse> = {
  encode(message: QueryValidatorsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.validators) {
      ValidatorHV.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
...
export const QueryValidatorResponse: MessageFns<QueryValidatorResponse> = {
  encode(message: QueryValidatorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.validator !== undefined) {
      ValidatorHV.encode(message.validator, writer.uint32(10).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.validator = ValidatorHV.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QueryValidatorResponse {
    return { validator: isSet(object.validator) ? ValidatorHV.fromJSON(object.validator) : undefined };
  },

  toJSON(message: QueryValidatorResponse): unknown {
    const obj: any = {};
    if (message.validator !== undefined) {
      obj.validator = ValidatorHV.toJSON(message.validator);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryValidatorResponse>, I>>(object: I): QueryValidatorResponse {
    ...
    message.validator = (object.validator !== undefined && object.validator !== null)
      ? ValidatorHV.fromPartial(object.validator)
      : undefined;
    return message;
  },
};
...
export const QueryHistoricalInfoResponse: MessageFns<QueryHistoricalInfoResponse> = {
  encode(message: QueryHistoricalInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hist !== undefined) {
      HistoricalInfoHV.encode(message.hist, writer.uint32(10).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.hist = HistoricalInfoHV.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QueryHistoricalInfoResponse {
    return { hist: isSet(object.hist) ? HistoricalInfoHV.fromJSON(object.hist) : undefined };
  },

  toJSON(message: QueryHistoricalInfoResponse): unknown {
    const obj: any = {};
    if (message.hist !== undefined) {
      obj.hist = HistoricalInfoHV.toJSON(message.hist);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryHistoricalInfoResponse>, I>>(object: I): QueryHistoricalInfoResponse {
    ...
    message.hist = (object.hist !== undefined && object.hist !== null)
      ? HistoricalInfoHV.fromPartial(object.hist)
      : undefined;
    return message;
  },
};
...
function createBaseQueryParamsResponse(): QueryParamsResponse {
  return { Params: undefined, HVParams: undefined };
}
...
function createBaseQueryPowerRequest(): QueryPowerRequest {
  return {};
}

export const QueryPowerRequest: MessageFns<QueryPowerRequest> = {
  encode(_: QueryPowerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryPowerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryPowerRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): QueryPowerRequest {
    return {};
  },

  toJSON(_: QueryPowerRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryPowerRequest>, I>>(base?: I): QueryPowerRequest {
    return QueryPowerRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryPowerRequest>, I>>(_: I): QueryPowerRequest {
    const message = createBaseQueryPowerRequest();
    return message;
  },
};

function createBaseValidatorPower(): ValidatorPower {
  return { operatorAddr: "", consAddr: "", power: 0, jailed: false, status: 0 };
}

export const ValidatorPower: MessageFns<ValidatorPower> = {
  encode(message: ValidatorPower, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.operatorAddr !== "") {
      writer.uint32(10).string(message.operatorAddr);
    }
    if (message.consAddr !== "") {
      writer.uint32(18).string(message.consAddr);
    }
    if (message.power !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidatorPower {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseValidatorPower();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ValidatorPower {
    return {
      operatorAddr: isSet(object.operatorAddr) ? globalThis.String(object.operatorAddr) : "",
  ...
  toJSON(message: ValidatorPower): unknown {
    const obj: any = {};
    if (message.operatorAddr !== "") {
  ...
  create<I extends Exact<DeepPartial<ValidatorPower>, I>>(base?: I): ValidatorPower {
    return ValidatorPower.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ValidatorPower>, I>>(object: I): ValidatorPower {
    const message = createBaseValidatorPower();
...
function createBaseQueryPowerResponse(): QueryPowerResponse {
  return { validatorPower: [], totalPower: 0, height: 0 };
}

export const QueryPowerResponse: MessageFns<QueryPowerResponse> = {
  encode(message: QueryPowerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.validatorPower) {
      ValidatorPower.encode(v!, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPowerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryPowerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.validatorPower.push(ValidatorPower.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.totalPower = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  fromJSON(object: any): QueryPowerResponse {
    return {
      validatorPower: globalThis.Array.isArray(object?.validatorPower)
        ? object.validatorPower.map((e: any) => ValidatorPower.fromJSON(e))
        : [],
  ...
  toJSON(message: QueryPowerResponse): unknown {
    const obj: any = {};
    if (message.validatorPower?.length) {
      obj.validatorPower = message.validatorPower.map((e) => ValidatorPower.toJSON(e));
    }
    if (message.totalPower !== 0) {
  ...
  create<I extends Exact<DeepPartial<QueryPowerResponse>, I>>(base?: I): QueryPowerResponse {
    return QueryPowerResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryPowerResponse>, I>>(object: I): QueryPowerResponse {
    const message = createBaseQueryPowerResponse();
    message.validatorPower = object.validatorPower?.map((e) => ValidatorPower.fromPartial(e)) || [];
...
function createBaseQueryBackfillRequestsRequest(): QueryBackfillRequestsRequest {
  return {};
}

export const QueryBackfillRequestsRequest: MessageFns<QueryBackfillRequestsRequest> = {
  encode(_: QueryBackfillRequestsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryBackfillRequestsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryBackfillRequestsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): QueryBackfillRequestsRequest {
    return {};
  },

  toJSON(_: QueryBackfillRequestsRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryBackfillRequestsRequest>, I>>(base?: I): QueryBackfillRequestsRequest {
    return QueryBackfillRequestsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBackfillRequestsRequest>, I>>(_: I): QueryBackfillRequestsRequest {
    const message = createBaseQueryBackfillRequestsRequest();
    return message;
  },
};

function createBaseQueryBackfillRequestsResponse(): QueryBackfillRequestsResponse {
  return { backfillRequests: undefined };
}

export const QueryBackfillRequestsResponse: MessageFns<QueryBackfillRequestsResponse> = {
  encode(message: QueryBackfillRequestsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.backfillRequests !== undefined) {
      BackfillRequests.encode(message.backfillRequests, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryBackfillRequestsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryBackfillRequestsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.backfillRequests = BackfillRequests.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QueryBackfillRequestsResponse {
    return {
      backfillRequests: isSet(object.backfillRequests) ? BackfillRequests.fromJSON(object.backfillRequests) : undefined,
    };
  },

  toJSON(message: QueryBackfillRequestsResponse): unknown {
    const obj: any = {};
    if (message.backfillRequests !== undefined) {
      obj.backfillRequests = BackfillRequests.toJSON(message.backfillRequests);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryBackfillRequestsResponse>, I>>(base?: I): QueryBackfillRequestsResponse {
    return QueryBackfillRequestsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryBackfillRequestsResponse>, I>>(
    object: I,
  ): QueryBackfillRequestsResponse {
    const message = createBaseQueryBackfillRequestsResponse();
    message.backfillRequests = (object.backfillRequests !== undefined && object.backfillRequests !== null)
      ? BackfillRequests.fromPartial(object.backfillRequests)
      : undefined;
    return message;
  },
};
...
export interface Query {
  ...
  ValidatorPower(request: QueryPowerRequest): Promise<QueryPowerResponse>;
  /** BackfillRequests queries the backfill requests. */
  QueryBackfillRequests(request: QueryBackfillRequestsRequest): Promise<QueryBackfillRequestsResponse>;
}

export const QueryServiceName = "zrchain.validation.Query";
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.ValidatorPower = this.ValidatorPower.bind(this);
    this.QueryBackfillRequests = this.QueryBackfillRequests.bind(this);
  }
  Validators(request: QueryValidatorsRequest): Promise<QueryValidatorsResponse> {
  ...
  ValidatorPower(request: QueryPowerRequest): Promise<QueryPowerResponse> {
    const data = QueryPowerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "ValidatorPower", data);
    return promise.then((data) => QueryPowerResponse.decode(new BinaryReader(data)));
  }

  QueryBackfillRequests(request: QueryBackfillRequestsRequest): Promise<QueryBackfillRequestsResponse> {
    const data = QueryBackfillRequestsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "QueryBackfillRequests", data);
    return promise.then((data) => QueryBackfillRequestsResponse.decode(new BinaryReader(data)));
  }
}
