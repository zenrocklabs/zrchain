...
class Swap(_message.Message):
    __slots__ = ("id", "status", "pair", "data", "sender_key_id", "recipient_key_id", "workspace", "zenbtc_yield")
    ...
    workspace: str
    zenbtc_yield: bool
    def __init__(self, id: _Optional[int] = ..., status: _Optional[_Union[SwapStatus, str]] = ..., pair: _Optional[_Union[SwapPair, _Mapping]] = ..., data: _Optional[_Union[SwapData, _Mapping]] = ..., sender_key_id: _Optional[int] = ..., recipient_key_id: _Optional[int] = ..., workspace: _Optional[str] = ..., zenbtc_yield: bool = ...) -> None: ...
