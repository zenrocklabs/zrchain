...
class MsgVerifyDepositBlockInclusion(_message.Message):
    __slots__ = ("creator", "chain_name", "block_height", "raw_tx", "index", "proof", "deposit_addr", "amount", "vout", "asset")
    ...
    def __init__(self, creator: _Optional[str] = ..., chain_name: _Optional[str] = ..., block_height: _Optional[int] = ..., raw_tx: _Optional[str] = ..., index: _Optional[int] = ..., proof: _Optional[_Iterable[str]] = ..., deposit_addr: _Optional[str] = ..., amount: _Optional[int] = ..., vout: _Optional[int] = ..., asset: _Optional[_Union[_params_pb2.Asset, str]] = ...) -> None: ...
...
class MsgSubmitUnsignedRedemptionTx(_message.Message):
    __slots__ = ("creator", "inputs", "txbytes", "cacheId", "chain_name", "redemption_indexes", "asset")
    CREATOR_FIELD_NUMBER: _ClassVar[int]
    ...
    asset: _params_pb2.Asset
    def __init__(self, creator: _Optional[str] = ..., inputs: _Optional[_Iterable[_Union[InputHashes, _Mapping]]] = ..., txbytes: _Optional[bytes] = ..., cacheId: _Optional[bytes] = ..., chain_name: _Optional[str] = ..., redemption_indexes: _Optional[_Iterable[int]] = ..., asset: _Optional[_Union[_params_pb2.Asset, str]] = ...) -> None: ...
