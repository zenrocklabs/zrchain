...
class Params(_message.Message):
    __slots__ = ("btc_proxy_address", "zenex_pool_key_id", "minimum_satoshis")
    ...
    def __init__(self, btc_proxy_address: _Optional[str] = ..., zenex_pool_key_id: _Optional[int] = ..., minimum_satoshis: _Optional[int] = ...) -> None: ...
