...
class MsgNewKeyring(_message.Message):
    __slots__ = ("creator", "description", "party_threshold", "key_req_fee", "sig_req_fee")
    CREATOR_FIELD_NUMBER: _ClassVar[int]
    ...
    key_req_fee: int
    sig_req_fee: int
    def __init__(self, creator: _Optional[str] = ..., description: _Optional[str] = ..., party_threshold: _Optional[int] = ..., key_req_fee: _Optional[int] = ..., sig_req_fee: _Optional[int] = ...) -> None: ...
