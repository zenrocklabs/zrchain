...
class Keyring(_message.Message):
    __slots__ = ("address", "creator", "description", "admins", "parties", "party_threshold", "key_req_fee", "sig_req_fee", "is_active", "delegate_fees", "mpc_default_timeout", "mpc_minimum_timeout")
