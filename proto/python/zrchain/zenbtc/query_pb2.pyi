...
class QueryBurnEventsRequest(_message.Message):
    __slots__ = ("startIndex", "txID", "logIndex", "caip2chainID", "status")
    ...
    def __init__(self, startIndex: _Optional[int] = ..., txID: _Optional[str] = ..., logIndex: _Optional[int] = ..., caip2chainID: _Optional[str] = ..., status: _Optional[_Union[_redemptions_pb2.BurnStatus, str]] = ...) -> None: ...
