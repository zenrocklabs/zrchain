...
class HVParams(_message.Message):
    __slots__ = ("AVSRewardsRate", "BlockTime", "stakeableAssets", "priceRetentionBlockRange", "VEJailingEnabled", "VEJailDurationMinutes", "VEWindowSize", "VEJailThreshold", "RedemptionDelaySeconds")
    ...
    REDEMPTIONDELAYSECONDS_FIELD_NUMBER: _ClassVar[int]
    AVSRewardsRate: str
    BlockTime: int
    ...
    VEWindowSize: int
    VEJailThreshold: int
    RedemptionDelaySeconds: int
    def __init__(self, AVSRewardsRate: _Optional[str] = ..., BlockTime: _Optional[int] = ..., stakeableAssets: _Optional[_Iterable[_Union[_asset_data_pb2.AssetData, _Mapping]]] = ..., priceRetentionBlockRange: _Optional[int] = ..., VEJailingEnabled: bool = ..., VEJailDurationMinutes: _Optional[int] = ..., VEWindowSize: _Optional[int] = ..., VEJailThreshold: _Optional[int] = ..., RedemptionDelaySeconds: _Optional[int] = ...) -> None: ...
