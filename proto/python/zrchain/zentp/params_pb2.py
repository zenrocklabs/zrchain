...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PARAMS']._serialized_end=289
  _globals['_SOLANA']._serialized_start=292
  _globals['_SOLANA']._serialized_end=567
