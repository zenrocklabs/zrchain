...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z<github.com/cosmos/ibc-go/v9/modules/core/23-commitment/types'
