...
class MsgConnectionOpenTry(_message.Message):
    __slots__ = ("client_id", "previous_connection_id", "client_state", "counterparty", "delay_period", "counterparty_versions", "proof_height", "proof_init", "proof_client", "proof_consensus", "consensus_height", "signer", "host_consensus_state_proof")
    CLIENT_ID_FIELD_NUMBER: _ClassVar[int]
...
class MsgConnectionOpenAck(_message.Message):
    __slots__ = ("connection_id", "counterparty_connection_id", "version", "client_state", "proof_height", "proof_try", "proof_client", "proof_consensus", "consensus_height", "signer", "host_consensus_state_proof")
