...
class GenesisState(_message.Message):
    __slots__ = ("channels", "acknowledgements", "commitments", "receipts", "send_sequences", "recv_sequences", "ack_sequences", "next_channel_sequence", "params")
