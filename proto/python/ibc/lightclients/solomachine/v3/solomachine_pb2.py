...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZLgithub.com/cosmos/ibc-go/v9/modules/light-clients/06-solomachine;solomachine'
