...
class QueryIncentivizedPacketsResponse(_message.Message):
    __slots__ = ("incentivized_packets", "pagination")
    ...
    def __init__(self, incentivized_packets: _Optional[_Iterable[_Union[_fee_pb2.IdentifiedPacketFees, _Mapping]]] = ..., pagination: _Optional[_Union[_pagination_pb2.PageResponse, _Mapping]] = ...) -> None: ...
...
class QueryFeeEnabledChannelsResponse(_message.Message):
    __slots__ = ("fee_enabled_channels", "pagination")
    ...
    pagination: _pagination_pb2.PageResponse
    def __init__(self, fee_enabled_channels: _Optional[_Iterable[_Union[_genesis_pb2.FeeEnabledChannel, _Mapping]]] = ..., pagination: _Optional[_Union[_pagination_pb2.PageResponse, _Mapping]] = ...) -> None: ...
