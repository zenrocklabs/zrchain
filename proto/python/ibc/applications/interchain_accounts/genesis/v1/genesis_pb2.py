...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZMgithub.com/cosmos/ibc-go/v9/modules/apps/27-interchain-accounts/genesis/types'
