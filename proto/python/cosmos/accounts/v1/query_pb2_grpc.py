...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AccountNumber = channel.unary_unary(
                '/cosmos.accounts.v1.Query/AccountNumber',
                request_serializer=cosmos_dot_accounts_dot_v1_dot_query__pb2.AccountNumberRequest.SerializeToString,
                response_deserializer=cosmos_dot_accounts_dot_v1_dot_query__pb2.AccountNumberResponse.FromString,
                )
...
def add_QueryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AccountNumber': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=cosmos_dot_accounts_dot_v1_dot_query__pb2.AccountNumberRequest.FromString,
                    response_serializer=cosmos_dot_accounts_dot_v1_dot_query__pb2.AccountNumberResponse.SerializeToString,
            ),
    }
...
class Query(object):
    ...
    def AccountNumber(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.accounts.v1.Query/AccountNumber',
            cosmos_dot_accounts_dot_v1_dot_query__pb2.AccountNumberRequest.SerializeToString,
            cosmos_dot_accounts_dot_v1_dot_query__pb2.AccountNumberResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
