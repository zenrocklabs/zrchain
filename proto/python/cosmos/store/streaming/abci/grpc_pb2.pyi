...
class ListenFinalizeBlockRequest(_message.Message):
    ...
    req: _types_pb2.FinalizeBlockRequest
    res: _types_pb2.FinalizeBlockResponse
    def __init__(self, req: _Optional[_Union[_types_pb2.FinalizeBlockRequest, _Mapping]] = ..., res: _Optional[_Union[_types_pb2.FinalizeBlockResponse, _Mapping]] = ...) -> None: ...
...
class ListenCommitRequest(_message.Message):
    ...
    block_height: int
    res: _types_pb2.CommitResponse
    change_set: _containers.RepeatedCompositeFieldContainer[_listening_pb2.StoreKVPair]
    def __init__(self, block_height: _Optional[int] = ..., res: _Optional[_Union[_types_pb2.CommitResponse, _Mapping]] = ..., change_set: _Optional[_Iterable[_Union[_listening_pb2.StoreKVPair, _Mapping]]] = ...) -> None: ...
