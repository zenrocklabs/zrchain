...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n cosmos/tx/config/v1/config.proto\x12\x13\x63osmos.tx.config.v1\x1a cosmos/app/v1alpha1/module.proto\"\x80\x01\n\x06\x43onfig\x12*\n\x11skip_ante_handler\x18\x01 \x01(\x08R\x0fskipAnteHandler\x12*\n\x11skip_post_handler\x18\x02 \x01(\x08R\x0fskipPostHandler:\x1e\xba\xc0\x96\xda\x01\x18\n\x16\x63osmossdk.io/x/auth/txb\x06proto3')
