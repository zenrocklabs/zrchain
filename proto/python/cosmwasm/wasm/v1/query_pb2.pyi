...
class QueryCodeInfoRequest(_message.Message):
    __slots__ = ("code_id",)
    CODE_ID_FIELD_NUMBER: _ClassVar[int]
    code_id: int
    def __init__(self, code_id: _Optional[int] = ...) -> None: ...

class QueryCodeInfoResponse(_message.Message):
    __slots__ = ("code_id", "creator", "checksum", "instantiate_permission")
    CODE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, code_id: _Optional[int] = ..., creator: _Optional[str] = ..., checksum: _Optional[bytes] = ..., instantiate_permission: _Optional[_Union[_types_pb2.AccessConfig, _Mapping]] = ...) -> None: ...
