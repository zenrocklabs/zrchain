...
const (
	Query_QueryParams_FullMethodName                  = "/zrchain.dct.Query/QueryParams"
	Query_GetLockTransactions_FullMethodName          = "/zrchain.dct.Query/GetLockTransactions"
	Query_GetRedemptions_FullMethodName               = "/zrchain.dct.Query/GetRedemptions"
	Query_QueryPendingMintTransactions_FullMethodName = "/zrchain.dct.Query/QueryPendingMintTransactions"
	Query_QueryPendingMintTransaction_FullMethodName  = "/zrchain.dct.Query/QueryPendingMintTransaction"
	Query_QuerySupply_FullMethodName                  = "/zrchain.dct.Query/QuerySupply"
	Query_QueryBurnEvents_FullMethodName              = "/zrchain.dct.Query/QueryBurnEvents"
)
