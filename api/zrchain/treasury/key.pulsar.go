...
var _ protoreflect.List = (*_KeyReqResponse_15_list)(nil)

type _KeyReqResponse_15_list struct {
	list *[]*PartySignature
}

func (x *_KeyReqResponse_15_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_KeyReqResponse_15_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_KeyReqResponse_15_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*PartySignature)
	(*x.list)[i] = concreteValue
}

func (x *_KeyReqResponse_15_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*PartySignature)
	*x.list = append(*x.list, concreteValue)
}

func (x *_KeyReqResponse_15_list) AppendMutable() protoreflect.Value {
	v := new(PartySignature)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_KeyReqResponse_15_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_KeyReqResponse_15_list) NewElement() protoreflect.Value {
	v := new(PartySignature)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_KeyReqResponse_15_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_KeyReqResponse_keyring_party_sigs       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_KeyReqResponse_keyring_party_sigs = md_KeyReqResponse.Fields().ByName("keyring_party_sigs")
}
...
func (x *fastReflection_KeyReqResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.KeyringPartySigs) != 0 {
		value := protoreflect.ValueOfList(&_KeyReqResponse_15_list{list: &x.KeyringPartySigs})
		if !f(fd_KeyReqResponse_keyring_party_sigs, value) {
			return
		}
	}
}
...
func (x *fastReflection_KeyReqResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "zrchain.treasury.KeyReqResponse.public_key":
		return len(x.PublicKey) != 0
	case "zrchain.treasury.KeyReqResponse.keyring_party_sigs":
		return len(x.KeyringPartySigs) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_KeyReqResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "zrchain.treasury.KeyReqResponse.keyring_party_sigs":
		if len(x.KeyringPartySigs) == 0 {
			return protoreflect.ValueOfList(&_KeyReqResponse_15_list{})
		}
		listValue := &_KeyReqResponse_15_list{list: &x.KeyringPartySigs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.KeyReqResponse"))
...
func (x *fastReflection_KeyReqResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "zrchain.treasury.KeyReqResponse.keyring_party_sigs":
		lv := value.List()
		clv := lv.(*_KeyReqResponse_15_list)
		x.KeyringPartySigs = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.KeyReqResponse"))
...
func (x *fastReflection_KeyReqResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "zrchain.treasury.KeyReqResponse.keyring_party_sigs":
		...
		value := &_KeyReqResponse_15_list{list: &x.KeyringPartySigs}
		return protoreflect.ValueOfList(value)
	case "zrchain.treasury.KeyReqResponse.id":
...
func (x *fastReflection_KeyReqResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "zrchain.treasury.KeyReqResponse.keyring_party_sigs":
		list := []*PartySignature{}
		return protoreflect.ValueOfList(&_KeyReqResponse_15_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.KeyReqResponse"))
		}
...
func (x *KeyReqResponse) GetKeyringPartySigs() []*PartySignature {
	if x != nil {
		return x.KeyringPartySigs
	}
	return nil
...
var file_zrchain_treasury_key_proto_rawDesc = []byte{
	...
	0x22, 0xdd, 0x04, 0x0a, 0x0e, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x5e, 0x0a, 0x18, 0x6b, 0x65,
	...
	0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72, 0x65, 0x61, 0x73, 0x75, 0x72, 0x79, 0x2e,
	0x50, 0x61, 0x72, 0x74, 0x79, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x42, 0x02,
	0x18, 0x01, 0x52, 0x16, 0x6b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x50, 0x61, 0x72, 0x74, 0x79,
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x72, 0x65,
	0x6a, 0x65, 0x63, 0x74, 0x5f, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0c, 0x72, 0x65, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12,
	...
	0x62, 0x74, 0x63, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xe4, 0x01, 0x0a, 0x0e,
	...
	0x70, 0x65, 0x12, 0x1d, 0x0a, 0x08, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x04, 0x42, 0x02, 0x18, 0x01, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49,
	0x64, 0x12, 0x29, 0x0a, 0x0e, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x5f, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0d, 0x72,
	0x65, 0x74, 0x75, 0x72, 0x6e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x24, 0x0a, 0x0e,
	...
	0x49, 0x64, 0x2a, 0xb9, 0x01, 0x0a, 0x10, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_zrchain_treasury_key_proto_depIdxs = []int32{
	...
	2,  // 6: zrchain.treasury.KeyReqResponse.keyring_party_sigs:type_name -> zrchain.treasury.PartySignature
	1,  // 7: zrchain.treasury.Key.type:type_name -> zrchain.treasury.KeyType
	7,  // 8: zrchain.treasury.Key.zenbtc_metadata:type_name -> zrchain.treasury.ZenBTCMetadata
	7,  // 9: zrchain.treasury.KeyResponse.zenbtc_metadata:type_name -> zrchain.treasury.ZenBTCMetadata
	8,  // 10: zrchain.treasury.ZenBTCMetadata.chain_type:type_name -> zrchain.treasury.WalletType
