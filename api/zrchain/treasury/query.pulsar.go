...
var (
	md_QueryFeeExcemptsRequest protoreflect.MessageDescriptor
)

func init() {
	file_zrchain_treasury_query_proto_init()
	md_QueryFeeExcemptsRequest = File_zrchain_treasury_query_proto.Messages().ByName("QueryFeeExcemptsRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryFeeExcemptsRequest)(nil)

type fastReflection_QueryFeeExcemptsRequest QueryFeeExcemptsRequest

func (x *QueryFeeExcemptsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryFeeExcemptsRequest)(x)
}

func (x *QueryFeeExcemptsRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryFeeExcemptsRequest_messageType fastReflection_QueryFeeExcemptsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryFeeExcemptsRequest_messageType{}

type fastReflection_QueryFeeExcemptsRequest_messageType struct{}

func (x fastReflection_QueryFeeExcemptsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryFeeExcemptsRequest)(nil)
}
func (x fastReflection_QueryFeeExcemptsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExcemptsRequest)
}
func (x fastReflection_QueryFeeExcemptsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExcemptsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryFeeExcemptsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExcemptsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryFeeExcemptsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryFeeExcemptsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryFeeExcemptsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExcemptsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryFeeExcemptsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryFeeExcemptsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryFeeExcemptsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryFeeExcemptsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsRequest"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExcemptsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryFeeExcemptsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsRequest"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExcemptsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryFeeExcemptsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryFeeExcemptsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.treasury.QueryFeeExcemptsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryFeeExcemptsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryFeeExcemptsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryFeeExcemptsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryFeeExcemptsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExcemptsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExcemptsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var _ protoreflect.List = (*_QueryFeeExcemptsResponse_1_list)(nil)

type _QueryFeeExcemptsResponse_1_list struct {
	list *[]string
}

func (x *_QueryFeeExcemptsResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryFeeExcemptsResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_QueryFeeExcemptsResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_QueryFeeExcemptsResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryFeeExcemptsResponse_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message QueryFeeExcemptsResponse at list field NoFeeMsgs as it is not of Message kind"))
}

func (x *_QueryFeeExcemptsResponse_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_QueryFeeExcemptsResponse_1_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_QueryFeeExcemptsResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryFeeExcemptsResponse             protoreflect.MessageDescriptor
	fd_QueryFeeExcemptsResponse_no_fee_msgs protoreflect.FieldDescriptor
)

func init() {
	file_zrchain_treasury_query_proto_init()
	md_QueryFeeExcemptsResponse = File_zrchain_treasury_query_proto.Messages().ByName("QueryFeeExcemptsResponse")
	fd_QueryFeeExcemptsResponse_no_fee_msgs = md_QueryFeeExcemptsResponse.Fields().ByName("no_fee_msgs")
}

var _ protoreflect.Message = (*fastReflection_QueryFeeExcemptsResponse)(nil)

type fastReflection_QueryFeeExcemptsResponse QueryFeeExcemptsResponse

func (x *QueryFeeExcemptsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryFeeExcemptsResponse)(x)
}

func (x *QueryFeeExcemptsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryFeeExcemptsResponse_messageType fastReflection_QueryFeeExcemptsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryFeeExcemptsResponse_messageType{}

type fastReflection_QueryFeeExcemptsResponse_messageType struct{}

func (x fastReflection_QueryFeeExcemptsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryFeeExcemptsResponse)(nil)
}
func (x fastReflection_QueryFeeExcemptsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExcemptsResponse)
}
func (x fastReflection_QueryFeeExcemptsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExcemptsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryFeeExcemptsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExcemptsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryFeeExcemptsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryFeeExcemptsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryFeeExcemptsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExcemptsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryFeeExcemptsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryFeeExcemptsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryFeeExcemptsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.NoFeeMsgs) != 0 {
		value := protoreflect.ValueOfList(&_QueryFeeExcemptsResponse_1_list{list: &x.NoFeeMsgs})
		if !f(fd_QueryFeeExcemptsResponse_no_fee_msgs, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryFeeExcemptsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExcemptsResponse.no_fee_msgs":
		return len(x.NoFeeMsgs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsResponse"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExcemptsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExcemptsResponse.no_fee_msgs":
		x.NoFeeMsgs = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryFeeExcemptsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "zrchain.treasury.QueryFeeExcemptsResponse.no_fee_msgs":
		if len(x.NoFeeMsgs) == 0 {
			return protoreflect.ValueOfList(&_QueryFeeExcemptsResponse_1_list{})
		}
		listValue := &_QueryFeeExcemptsResponse_1_list{list: &x.NoFeeMsgs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsResponse"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExcemptsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExcemptsResponse.no_fee_msgs":
		lv := value.List()
		clv := lv.(*_QueryFeeExcemptsResponse_1_list)
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExcemptsResponse.no_fee_msgs":
		if x.NoFeeMsgs == nil {
			x.NoFeeMsgs = []string{}
		}
		value := &_QueryFeeExcemptsResponse_1_list{list: &x.NoFeeMsgs}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryFeeExcemptsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExcemptsResponse.no_fee_msgs":
		list := []string{}
		return protoreflect.ValueOfList(&_QueryFeeExcemptsResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExcemptsResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryFeeExcemptsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.treasury.QueryFeeExcemptsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryFeeExcemptsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExcemptsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryFeeExcemptsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryFeeExcemptsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryFeeExcemptsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExcemptsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExcemptsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *QueryFeeExcemptsRequest) Reset() {
	*x = QueryFeeExcemptsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zrchain_treasury_query_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryFeeExcemptsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryFeeExcemptsRequest) ProtoMessage() {}

// Deprecated: Use QueryFeeExcemptsRequest.ProtoReflect.Descriptor instead.
...
func (x *QueryFeeExcemptsResponse) Reset() {
	*x = QueryFeeExcemptsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zrchain_treasury_query_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryFeeExcemptsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryFeeExcemptsResponse) ProtoMessage() {}

// Deprecated: Use QueryFeeExcemptsResponse.ProtoReflect.Descriptor instead.
func (*QueryFeeExcemptsResponse) Descriptor() ([]byte, []int) {
	return file_zrchain_treasury_query_proto_rawDescGZIP(), []int{29}
}

func (x *QueryFeeExcemptsResponse) GetNoFeeMsgs() []string {
	if x != nil {
		return x.NoFeeMsgs
	}
	return nil
...
var file_zrchain_treasury_query_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x23, 0x2f, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x76, 0x34, 0x2f, 0x74, 0x72, 0x65,
	0x61, 0x73, 0x75, 0x72, 0x79, 0x2f, 0x6b, 0x65, 0x79, 0x5f, 0x62, 0x79, 0x5f, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x12, 0xd3, 0x01, 0x0a, 0x0d, 0x5a, 0x65, 0x6e, 0x62, 0x74, 0x63, 0x57,
	0x61, 0x6c, 0x6c, 0x65, 0x74, 0x73, 0x12, 0x2b, 0x2e, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	,
...
var file_zrchain_treasury_query_proto_goTypes = []interface{}{
	...
	(*QueryFeeExcemptsRequest)(nil),                 // 28: zrchain.treasury.QueryFeeExcemptsRequest
	(*QueryFeeExcemptsResponse)(nil),                // 29: zrchain.treasury.QueryFeeExcemptsResponse
...
var file_zrchain_treasury_query_proto_depIdxs = []int32{
	...
	28, // 50: zrchain.treasury.Query.FeeExcempts:input_type -> zrchain.treasury.QueryFeeExcemptsRequest
	1,  // 51: zrchain.treasury.Query.Params:output_type -> zrchain.treasury.QueryParamsResponse
	3,  // 52: zrchain.treasury.Query.KeyRequests:output_type -> zrchain.treasury.QueryKeyRequestsResponse
	11, // 53: zrchain.treasury.Query.KeyRequestByID:output_type -> zrchain.treasury.QueryKeyRequestByIDResponse
	7,  // 54: zrchain.treasury.Query.Keys:output_type -> zrchain.treasury.QueryKeysResponse
	5,  // 55: zrchain.treasury.Query.KeyByID:output_type -> zrchain.treasury.QueryKeyByIDResponse
	13, // 56: zrchain.treasury.Query.SignatureRequests:output_type -> zrchain.treasury.QuerySignatureRequestsResponse
	15, // 57: zrchain.treasury.Query.SignatureRequestByID:output_type -> zrchain.treasury.QuerySignatureRequestByIDResponse
	17, // 58: zrchain.treasury.Query.SignTransactionRequests:output_type -> zrchain.treasury.QuerySignTransactionRequestsResponse
	20, // 59: zrchain.treasury.Query.SignTransactionRequestByID:output_type -> zrchain.treasury.QuerySignTransactionRequestByIDResponse
	23, // 60: zrchain.treasury.Query.ZrSignKeys:output_type -> zrchain.treasury.QueryZrSignKeysResponse
	25, // 61: zrchain.treasury.Query.KeyByAddress:output_type -> zrchain.treasury.QueryKeyByAddressResponse
	27, // 62: zrchain.treasury.Query.ZenbtcWallets:output_type -> zrchain.treasury.QueryZenbtcWalletsResponse
	29, // 63: zrchain.treasury.Query.FeeExcempts:output_type -> zrchain.treasury.QueryFeeExcemptsResponse
...
func file_zrchain_treasury_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_zrchain_treasury_query_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryFeeExcemptsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_zrchain_treasury_query_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryFeeExcemptsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
