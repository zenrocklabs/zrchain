...
var (
	md_QueryFeeExemptsRequest protoreflect.MessageDescriptor
)

func init() {
	file_zrchain_treasury_query_proto_init()
	md_QueryFeeExemptsRequest = File_zrchain_treasury_query_proto.Messages().ByName("QueryFeeExemptsRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryFeeExemptsRequest)(nil)

type fastReflection_QueryFeeExemptsRequest QueryFeeExemptsRequest

func (x *QueryFeeExemptsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryFeeExemptsRequest)(x)
}

func (x *QueryFeeExemptsRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryFeeExemptsRequest_messageType fastReflection_QueryFeeExemptsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryFeeExemptsRequest_messageType{}

type fastReflection_QueryFeeExemptsRequest_messageType struct{}

func (x fastReflection_QueryFeeExemptsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryFeeExemptsRequest)(nil)
}
func (x fastReflection_QueryFeeExemptsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExemptsRequest)
}
func (x fastReflection_QueryFeeExemptsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExemptsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryFeeExemptsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExemptsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryFeeExemptsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryFeeExemptsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryFeeExemptsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExemptsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryFeeExemptsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryFeeExemptsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryFeeExemptsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryFeeExemptsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsRequest"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExemptsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryFeeExemptsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsRequest"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExemptsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryFeeExemptsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryFeeExemptsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.treasury.QueryFeeExemptsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryFeeExemptsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryFeeExemptsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryFeeExemptsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryFeeExemptsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExemptsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExemptsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var _ protoreflect.List = (*_QueryFeeExemptsResponse_1_list)(nil)

type _QueryFeeExemptsResponse_1_list struct {
	list *[]string
}

func (x *_QueryFeeExemptsResponse_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QueryFeeExemptsResponse_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_QueryFeeExemptsResponse_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_QueryFeeExemptsResponse_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_QueryFeeExemptsResponse_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message QueryFeeExemptsResponse at list field NoFeeMsgs as it is not of Message kind"))
}

func (x *_QueryFeeExemptsResponse_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_QueryFeeExemptsResponse_1_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_QueryFeeExemptsResponse_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_QueryFeeExemptsResponse             protoreflect.MessageDescriptor
	fd_QueryFeeExemptsResponse_no_fee_msgs protoreflect.FieldDescriptor
)

func init() {
	file_zrchain_treasury_query_proto_init()
	md_QueryFeeExemptsResponse = File_zrchain_treasury_query_proto.Messages().ByName("QueryFeeExemptsResponse")
	fd_QueryFeeExemptsResponse_no_fee_msgs = md_QueryFeeExemptsResponse.Fields().ByName("no_fee_msgs")
}

var _ protoreflect.Message = (*fastReflection_QueryFeeExemptsResponse)(nil)

type fastReflection_QueryFeeExemptsResponse QueryFeeExemptsResponse

func (x *QueryFeeExemptsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryFeeExemptsResponse)(x)
}

func (x *QueryFeeExemptsResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryFeeExemptsResponse_messageType fastReflection_QueryFeeExemptsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryFeeExemptsResponse_messageType{}

type fastReflection_QueryFeeExemptsResponse_messageType struct{}

func (x fastReflection_QueryFeeExemptsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryFeeExemptsResponse)(nil)
}
func (x fastReflection_QueryFeeExemptsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExemptsResponse)
}
func (x fastReflection_QueryFeeExemptsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExemptsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryFeeExemptsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryFeeExemptsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryFeeExemptsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryFeeExemptsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryFeeExemptsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryFeeExemptsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryFeeExemptsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryFeeExemptsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryFeeExemptsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.NoFeeMsgs) != 0 {
		value := protoreflect.ValueOfList(&_QueryFeeExemptsResponse_1_list{list: &x.NoFeeMsgs})
		if !f(fd_QueryFeeExemptsResponse_no_fee_msgs, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryFeeExemptsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExemptsResponse.no_fee_msgs":
		return len(x.NoFeeMsgs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsResponse"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExemptsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExemptsResponse.no_fee_msgs":
		x.NoFeeMsgs = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryFeeExemptsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "zrchain.treasury.QueryFeeExemptsResponse.no_fee_msgs":
		if len(x.NoFeeMsgs) == 0 {
			return protoreflect.ValueOfList(&_QueryFeeExemptsResponse_1_list{})
		}
		listValue := &_QueryFeeExemptsResponse_1_list{list: &x.NoFeeMsgs}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsResponse"))
		}
		panic(fmt.Errorf("message zrchain.treasury.QueryFeeExemptsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExemptsResponse.no_fee_msgs":
		lv := value.List()
		clv := lv.(*_QueryFeeExemptsResponse_1_list)
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExemptsResponse.no_fee_msgs":
		if x.NoFeeMsgs == nil {
			x.NoFeeMsgs = []string{}
		}
		value := &_QueryFeeExemptsResponse_1_list{list: &x.NoFeeMsgs}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsResponse"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryFeeExemptsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "zrchain.treasury.QueryFeeExemptsResponse.no_fee_msgs":
		list := []string{}
		return protoreflect.ValueOfList(&_QueryFeeExemptsResponse_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.treasury.QueryFeeExemptsResponse"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryFeeExemptsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.treasury.QueryFeeExemptsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryFeeExemptsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryFeeExemptsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryFeeExemptsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryFeeExemptsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryFeeExemptsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExemptsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryFeeExemptsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
// QueryFeeExemptsRequest is request type for the
// Query/FeeExemptsRequest RPC method.
type QueryFeeExemptsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *QueryFeeExemptsRequest) Reset() {
	*x = QueryFeeExemptsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zrchain_treasury_query_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryFeeExemptsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryFeeExemptsRequest) ProtoMessage() {}

// Deprecated: Use QueryFeeExemptsRequest.ProtoReflect.Descriptor instead.
func (*QueryFeeExemptsRequest) Descriptor() ([]byte, []int) {
	return file_zrchain_treasury_query_proto_rawDescGZIP(), []int{28}
}

// QueryFeeExemptsResponse is response type for the
// Query/FeeExemptsResponse RPC method.
type QueryFeeExemptsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueryFeeExemptsResponse) Reset() {
	*x = QueryFeeExemptsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_zrchain_treasury_query_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryFeeExemptsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryFeeExemptsResponse) ProtoMessage() {}

// Deprecated: Use QueryFeeExemptsResponse.ProtoReflect.Descriptor instead.
func (*QueryFeeExemptsResponse) Descriptor() ([]byte, []int) {
	return file_zrchain_treasury_query_proto_rawDescGZIP(), []int{29}
}

func (x *QueryFeeExemptsResponse) GetNoFeeMsgs() []string {
	if x != nil {
		return x.NoFeeMsgs
	}
	return nil
...
var file_zrchain_treasury_query_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x18, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79, 0x46, 0x65, 0x65, 0x45, 0x78, 0x65,
	0x6d, 0x70, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x39, 0x0a, 0x17, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x46, 0x65, 0x65, 0x45, 0x78, 0x65, 0x6d, 0x70, 0x74, 0x73, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0b, 0x6e, 0x6f, 0x5f, 0x66, 0x65, 0x65,
	0x5f, 0x6d, 0x73, 0x67, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x6f, 0x46,
	0x65, 0x65, 0x4d, 0x73, 0x67, 0x73, 0x32, 0xda, 0x11, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x12, 0x77, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x24, 0x2e, 0x7a, 0x72, 0x63,
	...
	0x1a, 0x25, 0x2e, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74, 0x72, 0x65, 0x61, 0x73,
	0x75, 0x72, 0x79, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x20, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1a, 0x12,
	0x18, 0x2f, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x74, 0x72, 0x65, 0x61, 0x73, 0x75,
	0x72, 0x79, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0xb5, 0x01, 0x0a, 0x0b, 0x4b, 0x65,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x12, 0x29, 0x2e, 0x7a, 0x72, 0x63, 0x68,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a, 0x2e, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x74,
	...
	,
	...
	,
	...
	0x79, 0x2f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x73, 0x2f, 0x7b, 0x6b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x5f, 0x61, 0x64,
	0x64, 0x72, 0x7d, 0x2f, 0x7b, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x7d, 0x12, 0xb7, 0x01, 0x0a,
	0x14, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x42, 0x79, 0x49, 0x44, 0x12, 0x32, 0x2e, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_zrchain_treasury_query_proto_goTypes = []interface{}{
	...
	(*QueryFeeExemptsRequest)(nil),                  // 28: zrchain.treasury.QueryFeeExemptsRequest
	(*QueryFeeExemptsResponse)(nil),                 // 29: zrchain.treasury.QueryFeeExemptsResponse
...
var file_zrchain_treasury_query_proto_depIdxs = []int32{
	...
	28, // 50: zrchain.treasury.Query.FeeExempts:input_type -> zrchain.treasury.QueryFeeExemptsRequest
	...
	29, // 63: zrchain.treasury.Query.FeeExempts:output_type -> zrchain.treasury.QueryFeeExemptsResponse
...
func file_zrchain_treasury_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_zrchain_treasury_query_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryFeeExemptsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_zrchain_treasury_query_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryFeeExemptsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
