...
type MsgClient interface {
	...
	SubmitAVSUpdate(ctx context.Context, in *MsgSubmitAVSUpdate, opts ...grpc.CallOption) (*MsgSubmitAVSUpdateResponse, error)
	SubmitPriceUpdate(ctx context.Context, in *MsgSubmitPriceUpdate, opts ...grpc.CallOption) (*MsgSubmitPriceUpdateResponse, error)
	WhitelistOracle(ctx context.Context, in *MsgWhitelistOracle, opts ...grpc.CallOption) (*MsgWhitelistOracleResponse, error)
	UnwhitelistOracle(ctx context.Context, in *MsgUnwhitelistOracle, opts ...grpc.CallOption) (*MsgUnwhitelistOracleResponse, error)
	AddSupportedAsset(ctx context.Context, in *MsgAddSupportedAsset, opts ...grpc.CallOption) (*MsgAddSupportedAssetResponse, error)
}
...
func (c *msgClient) SubmitAVSUpdate(ctx context.Context, in *MsgSubmitAVSUpdate, opts ...grpc.CallOption) (*MsgSubmitAVSUpdateResponse, error) {
	out := new(MsgSubmitAVSUpdateResponse)
	err := c.cc.Invoke(ctx, "/zrchain.validation.Msg/SubmitAVSUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SubmitPriceUpdate(ctx context.Context, in *MsgSubmitPriceUpdate, opts ...grpc.CallOption) (*MsgSubmitPriceUpdateResponse, error) {
	out := new(MsgSubmitPriceUpdateResponse)
	err := c.cc.Invoke(ctx, "/zrchain.validation.Msg/SubmitPriceUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) WhitelistOracle(ctx context.Context, in *MsgWhitelistOracle, opts ...grpc.CallOption) (*MsgWhitelistOracleResponse, error) {
	out := new(MsgWhitelistOracleResponse)
	err := c.cc.Invoke(ctx, "/zrchain.validation.Msg/WhitelistOracle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UnwhitelistOracle(ctx context.Context, in *MsgUnwhitelistOracle, opts ...grpc.CallOption) (*MsgUnwhitelistOracleResponse, error) {
	out := new(MsgUnwhitelistOracleResponse)
	err := c.cc.Invoke(ctx, "/zrchain.validation.Msg/UnwhitelistOracle", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddSupportedAsset(ctx context.Context, in *MsgAddSupportedAsset, opts ...grpc.CallOption) (*MsgAddSupportedAssetResponse, error) {
	out := new(MsgAddSupportedAssetResponse)
	err := c.cc.Invoke(ctx, "/zrchain.validation.Msg/AddSupportedAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	SubmitAVSUpdate(context.Context, *MsgSubmitAVSUpdate) (*MsgSubmitAVSUpdateResponse, error)
	SubmitPriceUpdate(context.Context, *MsgSubmitPriceUpdate) (*MsgSubmitPriceUpdateResponse, error)
	WhitelistOracle(context.Context, *MsgWhitelistOracle) (*MsgWhitelistOracleResponse, error)
	UnwhitelistOracle(context.Context, *MsgUnwhitelistOracle) (*MsgUnwhitelistOracleResponse, error)
	AddSupportedAsset(context.Context, *MsgAddSupportedAsset) (*MsgAddSupportedAssetResponse, error)
...
func (UnimplementedMsgServer) SubmitAVSUpdate(context.Context, *MsgSubmitAVSUpdate) (*MsgSubmitAVSUpdateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitAVSUpdate not implemented")
}
func (UnimplementedMsgServer) SubmitPriceUpdate(context.Context, *MsgSubmitPriceUpdate) (*MsgSubmitPriceUpdateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitPriceUpdate not implemented")
}
func (UnimplementedMsgServer) WhitelistOracle(context.Context, *MsgWhitelistOracle) (*MsgWhitelistOracleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method WhitelistOracle not implemented")
}
func (UnimplementedMsgServer) UnwhitelistOracle(context.Context, *MsgUnwhitelistOracle) (*MsgUnwhitelistOracleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnwhitelistOracle not implemented")
}
func (UnimplementedMsgServer) AddSupportedAsset(context.Context, *MsgAddSupportedAsset) (*MsgAddSupportedAssetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddSupportedAsset not implemented")
}
...
func _Msg_SubmitAVSUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgSubmitAVSUpdate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SubmitAVSUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.validation.Msg/SubmitAVSUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SubmitAVSUpdate(ctx, req.(*MsgSubmitAVSUpdate))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_SubmitPriceUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgSubmitPriceUpdate)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SubmitPriceUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.validation.Msg/SubmitPriceUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SubmitPriceUpdate(ctx, req.(*MsgSubmitPriceUpdate))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_WhitelistOracle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgWhitelistOracle)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).WhitelistOracle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.validation.Msg/WhitelistOracle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).WhitelistOracle(ctx, req.(*MsgWhitelistOracle))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_UnwhitelistOracle_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgUnwhitelistOracle)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).UnwhitelistOracle(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.validation.Msg/UnwhitelistOracle",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).UnwhitelistOracle(ctx, req.(*MsgUnwhitelistOracle))
	}
	return interceptor(ctx, in, info, handler)
}

func _Msg_AddSupportedAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgAddSupportedAsset)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).AddSupportedAsset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.validation.Msg/AddSupportedAsset",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).AddSupportedAsset(ctx, req.(*MsgAddSupportedAsset))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Msg_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SubmitAVSUpdate",
			Handler:    _Msg_SubmitAVSUpdate_Handler,
		},
		{
			MethodName: "SubmitPriceUpdate",
			Handler:    _Msg_SubmitPriceUpdate_Handler,
		},
		{
			MethodName: "WhitelistOracle",
			Handler:    _Msg_WhitelistOracle_Handler,
		},
		{
			MethodName: "UnwhitelistOracle",
			Handler:    _Msg_UnwhitelistOracle_Handler,
		},
		{
			MethodName: "AddSupportedAsset",
			Handler:    _Msg_AddSupportedAsset_Handler,
		},
	},
