...
const (
	Query_Validators_FullMethodName                    = "/zrchain.validation.Query/Validators"
	Query_Validator_FullMethodName                     = "/zrchain.validation.Query/Validator"
	Query_ValidatorDelegations_FullMethodName          = "/zrchain.validation.Query/ValidatorDelegations"
	Query_ValidatorUnbondingDelegations_FullMethodName = "/zrchain.validation.Query/ValidatorUnbondingDelegations"
	Query_Delegation_FullMethodName                    = "/zrchain.validation.Query/Delegation"
	Query_UnbondingDelegation_FullMethodName           = "/zrchain.validation.Query/UnbondingDelegation"
	Query_DelegatorDelegations_FullMethodName          = "/zrchain.validation.Query/DelegatorDelegations"
	Query_DelegatorUnbondingDelegations_FullMethodName = "/zrchain.validation.Query/DelegatorUnbondingDelegations"
	Query_Redelegations_FullMethodName                 = "/zrchain.validation.Query/Redelegations"
	Query_DelegatorValidators_FullMethodName           = "/zrchain.validation.Query/DelegatorValidators"
	Query_DelegatorValidator_FullMethodName            = "/zrchain.validation.Query/DelegatorValidator"
	Query_HistoricalInfo_FullMethodName                = "/zrchain.validation.Query/HistoricalInfo"
	Query_Pool_FullMethodName                          = "/zrchain.validation.Query/Pool"
...
func (c *queryClient) ValidatorPower(ctx context.Context, in *QueryPowerRequest, opts ...grpc.CallOption) (*QueryPowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ValidatorPower_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryBackfillRequests(ctx context.Context, in *QueryBackfillRequestsRequest, opts ...grpc.CallOption) (*QueryBackfillRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QueryBackfillRequests_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ValidatorPower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ValidatorPower_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_QueryBackfillRequests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_QueryBackfillRequests_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
