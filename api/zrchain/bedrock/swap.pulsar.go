...
import (
	...
	validation "cosmossdk.io/api/zrchain/validation"
	fmt "fmt"
...
var (
	...
	fd_Swap_id               protoreflect.FieldDescriptor
...
func init() {
	file_zrchain_bedrock_swap_proto_init()
	md_Swap = File_zrchain_bedrock_swap_proto.Messages().ByName("Swap")
	fd_Swap_id = md_Swap.Fields().ByName("id")
...
func (x *Swap) slowProtoReflect() protoreflect.Message {
	mi := &file_zrchain_bedrock_swap_proto_msgTypes[0]
...
func (x *fastReflection_Swap) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "zrchain.bedrock.Swap.id":
		return x.Id != uint64(0)
	case "zrchain.bedrock.Swap.status":
		return x.Status != 0
	case "zrchain.bedrock.Swap.pair":
		return x.Pair != nil
	case "zrchain.bedrock.Swap.data":
		return x.Data != nil
	case "zrchain.bedrock.Swap.sender_key_id":
		return x.SenderKeyId != uint64(0)
	case "zrchain.bedrock.Swap.recipient_key_id":
		return x.RecipientKeyId != uint64(0)
	case "zrchain.bedrock.Swap.workspace":
		return x.Workspace != ""
	case "zrchain.bedrock.Swap.zenbtc_yield":
		return x.ZenbtcYield != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.bedrock.Swap"))
		}
		panic(fmt.Errorf("message zrchain.bedrock.Swap does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Swap) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message zrchain.bedrock.Swap does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Swap) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "zrchain.bedrock.Swap.pair":
		x.Pair = value.Message().Interface().(*SwapPair)
	case "zrchain.bedrock.Swap.data":
...
func (x *fastReflection_Swap) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "zrchain.bedrock.Swap.id":
		panic(fmt.Errorf("field id of message zrchain.bedrock.Swap is not mutable"))
	case "zrchain.bedrock.Swap.status":
		panic(fmt.Errorf("field status of message zrchain.bedrock.Swap is not mutable"))
	case "zrchain.bedrock.Swap.sender_key_id":
		panic(fmt.Errorf("field sender_key_id of message zrchain.bedrock.Swap is not mutable"))
	case "zrchain.bedrock.Swap.recipient_key_id":
		panic(fmt.Errorf("field recipient_key_id of message zrchain.bedrock.Swap is not mutable"))
	case "zrchain.bedrock.Swap.workspace":
		panic(fmt.Errorf("field workspace of message zrchain.bedrock.Swap is not mutable"))
	case "zrchain.bedrock.Swap.zenbtc_yield":
		panic(fmt.Errorf("field zenbtc_yield of message zrchain.bedrock.Swap is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.bedrock.Swap"))
		}
...
func (x *fastReflection_Swap) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.bedrock.Swap", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_zrchain_bedrock_swap_proto_init()
	md_SwapData = File_zrchain_bedrock_swap_proto.Messages().ByName("SwapData")
...
func (x *SwapData) slowProtoReflect() protoreflect.Message {
	mi := &file_zrchain_bedrock_swap_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SwapData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "zrchain.bedrock.SwapData.base_token":
		return x.BaseToken != nil
	case "zrchain.bedrock.SwapData.quote_token":
		return x.QuoteToken != nil
	case "zrchain.bedrock.SwapData.price":
		return x.Price != ""
	case "zrchain.bedrock.SwapData.amount_in":
		return x.AmountIn != ""
	case "zrchain.bedrock.SwapData.amount_out":
		return x.AmountOut != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.bedrock.SwapData"))
		}
		panic(fmt.Errorf("message zrchain.bedrock.SwapData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SwapData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message zrchain.bedrock.SwapData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SwapData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "zrchain.bedrock.SwapData.price":
		panic(fmt.Errorf("field price of message zrchain.bedrock.SwapData is not mutable"))
	case "zrchain.bedrock.SwapData.amount_in":
		panic(fmt.Errorf("field amount_in of message zrchain.bedrock.SwapData is not mutable"))
	case "zrchain.bedrock.SwapData.amount_out":
		panic(fmt.Errorf("field amount_out of message zrchain.bedrock.SwapData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.bedrock.SwapData"))
		}
...
func (x *fastReflection_SwapData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.bedrock.SwapData", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_zrchain_bedrock_swap_proto_init()
	md_SwapPair = File_zrchain_bedrock_swap_proto.Messages().ByName("SwapPair")
...
func (x *SwapPair) slowProtoReflect() protoreflect.Message {
	mi := &file_zrchain_bedrock_swap_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_SwapPair) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "zrchain.bedrock.SwapPair.base_token":
		return x.BaseToken != nil
	case "zrchain.bedrock.SwapPair.quote_token":
		return x.QuoteToken != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.bedrock.SwapPair"))
		}
		panic(fmt.Errorf("message zrchain.bedrock.SwapPair does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_SwapPair) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message zrchain.bedrock.SwapPair does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_SwapPair) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in zrchain.bedrock.SwapPair", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: zrchain/bedrock/swap.proto
...
func (SwapStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_zrchain_bedrock_swap_proto_enumTypes[0].Descriptor()
}

func (SwapStatus) Type() protoreflect.EnumType {
	return &file_zrchain_bedrock_swap_proto_enumTypes[0]
}
...
func (SwapStatus) EnumDescriptor() ([]byte, []int) {
	return file_zrchain_bedrock_swap_proto_rawDescGZIP(), []int{0}
}
...
type Swap struct {
	...
	Status         SwapStatus `protobuf:"varint,2,opt,name=status,proto3,enum=zrchain.bedrock.SwapStatus" json:"status,omitempty"`
	Pair           *SwapPair  `protobuf:"bytes,3,opt,name=pair,proto3" json:"pair,omitempty"`
...
func (*SwapData) Descriptor() ([]byte, []int) {
	return file_zrchain_bedrock_swap_proto_rawDescGZIP(), []int{1}
}
...
func (*SwapPair) Descriptor() ([]byte, []int) {
	return file_zrchain_bedrock_swap_proto_rawDescGZIP(), []int{2}
}
...
var File_zrchain_bedrock_swap_proto protoreflect.FileDescriptor

var file_zrchain_bedrock_swap_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x7a, 0x72, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x62, 0x65, 0x64, 0x72, 0x6f, 0x63,
	0x6b, 0x2f, 0x73, 0x77, 0x61, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x7a, 0x72,
	0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x62, 0x65, 0x64, 0x72, 0x6f, 0x63, 0x6b, 0x1a, 0x19, 0x63,
	...
	,
	...
	0x0a, 0x0c, 0x7a, 0x65, 0x6e, 0x62, 0x74, 0x63, 0x5f, 0x79, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x7a, 0x65, 0x6e, 0x62, 0x74, 0x63, 0x59, 0x69, 0x65, 0x6c,
	0x64, 0x22, 0xf9, 0x02, 0x0a, 0x08, 0x53, 0x77, 0x61, 0x70, 0x44, 0x61, 0x74, 0x61, 0x12, 0x3c,
	...
	0x4c, 0x0a, 0x0a, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x6f, 0x75, 0x74, 0x18, 0x05, 0x20,
	...
	,
}

var (
	file_zrchain_bedrock_swap_proto_rawDescOnce sync.Once
	file_zrchain_bedrock_swap_proto_rawDescData = file_zrchain_bedrock_swap_proto_rawDesc
)

func file_zrchain_bedrock_swap_proto_rawDescGZIP() []byte {
	file_zrchain_bedrock_swap_proto_rawDescOnce.Do(func() {
		file_zrchain_bedrock_swap_proto_rawDescData = protoimpl.X.CompressGZIP(file_zrchain_bedrock_swap_proto_rawDescData)
	})
	return file_zrchain_bedrock_swap_proto_rawDescData
}

var file_zrchain_bedrock_swap_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_zrchain_bedrock_swap_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_zrchain_bedrock_swap_proto_goTypes = []interface{}{
	(SwapStatus)(0),              // 0: zrchain.bedrock.SwapStatus
	(*Swap)(nil),                 // 1: zrchain.bedrock.Swap
	(*SwapData)(nil),             // 2: zrchain.bedrock.SwapData
	(*SwapPair)(nil),             // 3: zrchain.bedrock.SwapPair
	(*validation.AssetData)(nil), // 4: zrchain.validation.AssetData
}
var file_zrchain_bedrock_swap_proto_depIdxs = []int32{
	0, // 0: zrchain.bedrock.Swap.status:type_name -> zrchain.bedrock.SwapStatus
	3, // 1: zrchain.bedrock.Swap.pair:type_name -> zrchain.bedrock.SwapPair
	2, // 2: zrchain.bedrock.Swap.data:type_name -> zrchain.bedrock.SwapData
	4, // 3: zrchain.bedrock.SwapData.base_token:type_name -> zrchain.validation.AssetData
	4, // 4: zrchain.bedrock.SwapData.quote_token:type_name -> zrchain.validation.AssetData
	4, // 5: zrchain.bedrock.SwapPair.base_token:type_name -> zrchain.validation.AssetData
	4, // 6: zrchain.bedrock.SwapPair.quote_token:type_name -> zrchain.validation.AssetData
...
func init() { file_zrchain_bedrock_swap_proto_init() }
func file_zrchain_bedrock_swap_proto_init() {
	if File_zrchain_bedrock_swap_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_zrchain_bedrock_swap_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Swap); i {
			case 0:
				return &v.state
			case 1:
		...
		file_zrchain_bedrock_swap_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_zrchain_bedrock_swap_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_zrchain_bedrock_swap_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zrchain_bedrock_swap_proto_goTypes,
		DependencyIndexes: file_zrchain_bedrock_swap_proto_depIdxs,
		EnumInfos:         file_zrchain_bedrock_swap_proto_enumTypes,
		MessageInfos:      file_zrchain_bedrock_swap_proto_msgTypes,
	}.Build()
	File_zrchain_bedrock_swap_proto = out.File
	file_zrchain_bedrock_swap_proto_rawDesc = nil
	file_zrchain_bedrock_swap_proto_goTypes = nil
	file_zrchain_bedrock_swap_proto_depIdxs = nil
}
