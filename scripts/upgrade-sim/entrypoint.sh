...
curl -Ls https://github.com/Zenrock-Foundation/zrchain/releases/download/v$ZENROCKD_GENESIS_VERSION/zenrockd -o /root-data/cosmovisor/genesis/bin/zenrockd
...
curl -s https://rpc.diamond.zenrocklabs.io/genesis | jq .result.genesis > /root-data/config/genesis.json
