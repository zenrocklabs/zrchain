...
func initTestOracle() *sidecar.Oracle {
	...
	return sidecar.NewOracle(cfg, ethClient, nil, solanaClient, zrChainQueryClient, time.NewTicker(time.Duration(sidecartypes.MainLoopTickerIntervalSeconds)*time.Second))
}
