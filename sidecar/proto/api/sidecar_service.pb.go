...
type BTCBlockHeader struct {
	...
	FinalSaplingRoot string `protobuf:"bytes,10,opt,name=FinalSaplingRoot,proto3" json:"FinalSaplingRoot,omitempty"`
}
...
func (m *BTCBlockHeader) GetFinalSaplingRoot() string {
	if m != nil {
		return m.FinalSaplingRoot
	}
	return ""
}
...
var fileDescriptor_9f890d7da2148de8 = []byte{
	...
	,
}
...
func (m *BTCBlockHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.FinalSaplingRoot) > 0 {
		i -= len(m.FinalSaplingRoot)
		copy(dAtA[i:], m.FinalSaplingRoot)
		i = encodeVarintSidecarService(dAtA, i, uint64(len(m.FinalSaplingRoot)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.NonceHex) > 0 {
...
func (m *BTCBlockHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FinalSaplingRoot", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FinalSaplingRoot = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSidecarService(dAtA[iNdEx:])
