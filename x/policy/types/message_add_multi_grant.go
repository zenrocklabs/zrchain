...
var _ sdk.Msg = &MsgAddMultiGrant{}

func NewMsgAddMultiGrant(creator string, grantee string, msgs []string) *MsgAddMultiGrant {
...
func (msg *MsgAddMultiGrant) ValidateBasic() error {
