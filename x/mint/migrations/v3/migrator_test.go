...
func TestMigrate(t *testing.T) {
	...
	params := types.Params{
		...
		StakingYield:             math.LegacyNewDecWithPrec(7, 2),  // 0.07
		BurnRate:                 math.LegacyNewDecWithPrec(10, 2), // 0.10
		ProtocolWalletRate:       math.LegacyNewDecWithPrec(30, 2), // 0.30
		ProtocolWalletAddress:    "",
		RetentionRate:            math.LegacyNewDecWithPrec(40, 2), // 0.40
		AdditionalStakingRewards: math.LegacyNewDecWithPrec(30, 2), // 0.30
		AdditionalMpcRewards:     math.LegacyNewDecWithPrec(5, 2),  // 0.05
		AdditionalBurnRate:       math.LegacyNewDecWithPrec(25, 2), // 0.25
	}
