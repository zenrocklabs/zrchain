...
//
//	mockgen -source=x/mint/types/expected_keepers.go -destination=x/mint/testutil/expected_keepers_mocks.go -package=testutil
//
...
// UpdateZentpFees indicates an expected call of UpdateZentpFees.
func (mr *MockZentpKeeperMockRecorder) UpdateZentpFees(ctx, fees any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
