...
var _ sdk.Msg = &MsgDeactivateKeyring{}

func NewMsgDeactivateKeyring(creator string, keyringAddr string) *MsgDeactivateKeyring {
	return &MsgDeactivateKeyring{
		Creator:     creator,
		KeyringAddr: keyringAddr,
	}
}

func (msg *MsgDeactivateKeyring) ValidateBasic() error {
