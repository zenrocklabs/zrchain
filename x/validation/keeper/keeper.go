...
type Keeper struct {
	...
	// SolanaNonceRequested - value: bool (is requested)
	SolanaNonceRequested collections.Item[bool]
...
func NewKeeper(
	...
	return &Keeper{
		...
		SolanaNonceRequested:              collections.NewItem(sb, types.SolanaNonceRequestedKey, types.SolanaNonceRequestedIndex, collections.BoolValue),
