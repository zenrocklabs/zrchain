...
//
//	mockgen -source=x/validation/keeper/abci_types.go -destination=x/validation/testutil/abci_types_mocks.go -package=testutil
//
...
func (mr *MocksidecarClientMockRecorder) GetBitcoinBlockHeaderByHeight(ctx, in any, opts ...any) *gomock.Call {
...
func (mr *MocksidecarClientMockRecorder) GetLatestBitcoinBlockHeader(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
...
func (mr *MocksidecarClientMockRecorder) GetLatestEthereumNonceForAccount(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
...
func (mr *MocksidecarClientMockRecorder) GetSidecarState(ctx, arg1 any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MocksidecarClientMockRecorder) GetSidecarStateByEthHeight(ctx, req any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MocksidecarClientMockRecorder) GetSolanaAccountInfo(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
