...
func (m *MockValidatorSet) Delegation(arg0 context.Context, arg1 types2.AccAddress, arg2 types2.ValAddress) (types4.DelegationI, error) {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) IterateBondedValidatorsByPower(arg0 context.Context, arg1 func(int64, types4.ValidatorI) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) IterateValidators(arg0 context.Context, arg1 func(int64, types4.ValidatorI) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) SlashWithInfractionReason(arg0 context.Context, arg1 types2.ConsAddress, arg2, arg3 int64, arg4 math.LegacyDec, arg5 types4.Infraction) (math.Int, error) {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) Validator(arg0 context.Context, arg1 types2.ValAddress) (types4.ValidatorI, error) {
	m.ctrl.T.Helper()
...
func (m *MockValidatorSet) ValidatorByConsAddr(arg0 context.Context, arg1 types2.ConsAddress) (types4.ValidatorI, error) {
	m.ctrl.T.Helper()
...
func (m *MockDelegationSet) IterateDelegations(ctx context.Context, delegator types2.AccAddress, fn func(int64, types4.DelegationI) bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) AddBurn(ctx, burn interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) GetBridgeFeeAmount(ctx, amount, bridgeFee interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) GetBridgeFeeParams(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockZentpKeeper) GetBurns(goCtx context.Context, address, chainID, txHash string) ([]*types1.Bridge, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBurns", goCtx, address, chainID, txHash)
...
func (mr *MockZentpKeeperMockRecorder) GetBurns(goCtx, address, chainID, txHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBurns", reflect.TypeOf((*MockZentpKeeper)(nil).GetBurns), goCtx, address, chainID, txHash)
}
...
func (mr *MockZentpKeeperMockRecorder) GetMintsWithStatus(goCtx, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) GetMintsWithStatusPending(goCtx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) UpdateMint(ctx, id, mint interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTreasuryKeeperMockRecorder) GetSignRequest(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTreasuryKeeperMockRecorder) GetSignTransactionRequest(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSlashingKeeper) GetValidatorSigningInfo(ctx context.Context, address types2.ConsAddress) (types3.ValidatorSigningInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockSlashingKeeper) SetValidatorSigningInfo(ctx context.Context, address types2.ConsAddress, info types3.ValidatorSigningInfo) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetValidatorSigningInfo", ctx, address, info)
	ret0, _ := ret[0].(error)
	return ret0
}
