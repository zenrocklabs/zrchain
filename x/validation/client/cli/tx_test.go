...
func (s *CLITestSuite) TestNewCreateValidatorCmd() {
	require := s.Require()
	cmd := cli.NewCreateValidatorCmd(addresscodec.NewBech32Codec("zenvaloper"))
...
func (s *CLITestSuite) TestNewEditValidatorCmd() {
	cmd := cli.NewEditValidatorCmd(addresscodec.NewBech32Codec("zen"))
...
func (s *CLITestSuite) TestNewDelegateCmd() {
	cmd := cli.NewDelegateCmd(addresscodec.NewBech32Codec("zenvaloper"), addresscodec.NewBech32Codec("zen"))
...
func (s *CLITestSuite) TestNewRedelegateCmd() {
	cmd := cli.NewRedelegateCmd(addresscodec.NewBech32Codec("zenvaloper"), addresscodec.NewBech32Codec("zen"))
...
func (s *CLITestSuite) TestNewUnbondCmd() {
	cmd := cli.NewUnbondCmd(addresscodec.NewBech32Codec("zenvaloper"), addresscodec.NewBech32Codec("zen"))
...
func (s *CLITestSuite) TestNewCancelUnbondingDelegationCmd() {
	cmd := cli.NewCancelUnbondingDelegation(addresscodec.NewBech32Codec("zenvaloper"), addresscodec.NewBech32Codec("zen"))
