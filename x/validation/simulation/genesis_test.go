...
func TestRandomizedGenState(t *testing.T) {
	...
	// check Delegations
	require.Equal(t, "zen1tnh2q55v8wyygtt9srz5safamzdengsn65ke7q", stakingGenesis.Delegations[0].DelegatorAddress)
	require.Equal(t, "zenvaloper1tnh2q55v8wyygtt9srz5safamzdengsns4jcd6", stakingGenesis.Delegations[0].ValidatorAddress)
	require.Equal(t, "1000.000000000000000000", stakingGenesis.Delegations[0].Shares.String())
	// check validators
	require.Equal(t, "zenvaloper1ghekyjucln7y67ntx7cf27m9dpuxxemn953g2g", stakingGenesis.Validators[2].GetOperator())
