...
func TestDecodeStore(t *testing.T) {
	...
	ubd := types.NewUnbondingDelegation(delAddr1, valAddr1, 15, bondTime, math.OneInt(), 1, address.NewBech32Codec("zenvaloper"), address.NewBech32Codec("zen"))
	red := types.NewRedelegation(delAddr1, valAddr1, valAddr1, 12, bondTime, math.OneInt(), math.LegacyOneDec(), 0, address.NewBech32Codec("zenvaloper"), address.NewBech32Codec("zen"))
