...
func (m *QueryBackfillRequestsRequest) Reset()         { *m = QueryBackfillRequestsRequest{} }
func (m *QueryBackfillRequestsRequest) String() string { return proto.CompactTextString(m) }
func (*QueryBackfillRequestsRequest) ProtoMessage()    {}
func (*QueryBackfillRequestsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_572d475a38d07a89, []int{31}
}
func (m *QueryBackfillRequestsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryBackfillRequestsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryBackfillRequestsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryBackfillRequestsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryBackfillRequestsRequest.Merge(m, src)
}
func (m *QueryBackfillRequestsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryBackfillRequestsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryBackfillRequestsRequest.DiscardUnknown(m)
}
...
func (m *QueryBackfillRequestsResponse) Reset()         { *m = QueryBackfillRequestsResponse{} }
func (m *QueryBackfillRequestsResponse) String() string { return proto.CompactTextString(m) }
func (*QueryBackfillRequestsResponse) ProtoMessage()    {}
func (*QueryBackfillRequestsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_572d475a38d07a89, []int{32}
}
func (m *QueryBackfillRequestsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryBackfillRequestsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryBackfillRequestsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryBackfillRequestsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryBackfillRequestsResponse.Merge(m, src)
}
func (m *QueryBackfillRequestsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryBackfillRequestsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryBackfillRequestsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryBackfillRequestsResponse proto.InternalMessageInfo

func (m *QueryBackfillRequestsResponse) GetBackfillRequests() *BackfillRequests {
	if m != nil {
...
func (m *QuerySolanaCountersRequest) Reset()         { *m = QuerySolanaCountersRequest{} }
func (m *QuerySolanaCountersRequest) String() string { return proto.CompactTextString(m) }
func (*QuerySolanaCountersRequest) ProtoMessage()    {}
func (*QuerySolanaCountersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_572d475a38d07a89, []int{33}
}
func (m *QuerySolanaCountersRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QuerySolanaCountersRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QuerySolanaCountersRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QuerySolanaCountersRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuerySolanaCountersRequest.Merge(m, src)
}
func (m *QuerySolanaCountersRequest) XXX_Size() int {
	return m.Size()
}
func (m *QuerySolanaCountersRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QuerySolanaCountersRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QuerySolanaCountersRequest proto.InternalMessageInfo

func (m *QuerySolanaCountersRequest) GetAsset() string {
	if m != nil {
		return m.Asset
	}
	return ""
...
func (m *QuerySolanaCountersResponse) Reset()         { *m = QuerySolanaCountersResponse{} }
func (m *QuerySolanaCountersResponse) String() string { return proto.CompactTextString(m) }
func (*QuerySolanaCountersResponse) ProtoMessage()    {}
func (*QuerySolanaCountersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_572d475a38d07a89, []int{34}
}
func (m *QuerySolanaCountersResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QuerySolanaCountersResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QuerySolanaCountersResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QuerySolanaCountersResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QuerySolanaCountersResponse.Merge(m, src)
}
func (m *QuerySolanaCountersResponse) XXX_Size() int {
	return m.Size()
}
func (m *QuerySolanaCountersResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QuerySolanaCountersResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QuerySolanaCountersResponse proto.InternalMessageInfo

func (m *QuerySolanaCountersResponse) GetCounters() map[string]*SolanaCounters {
	if m != nil {
		return m.Counters
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryBackfillRequestsRequest)(nil), "zrchain.validation.QueryBackfillRequestsRequest")
	proto.RegisterType((*QueryBackfillRequestsResponse)(nil), "zrchain.validation.QueryBackfillRequestsResponse")
	proto.RegisterType((*QuerySolanaCountersRequest)(nil), "zrchain.validation.QuerySolanaCountersRequest")
	proto.RegisterType((*QuerySolanaCountersResponse)(nil), "zrchain.validation.QuerySolanaCountersResponse")
	proto.RegisterMapType((map[string]*SolanaCounters)(nil), "zrchain.validation.QuerySolanaCountersResponse.CountersEntry")
}
...
var fileDescriptor_572d475a38d07a89 = []byte{
	...
	,
}
...
func (c *queryClient) SolanaCounters(ctx context.Context, in *QuerySolanaCountersRequest, opts ...grpc.CallOption) (*QuerySolanaCountersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zrchain.validation.Query/SolanaCounters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) QueryBackfillRequests(ctx context.Context, req *QueryBackfillRequestsRequest) (*QueryBackfillRequestsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method QueryBackfillRequests not implemented")
}
func (*UnimplementedQueryServer) SolanaCounters(ctx context.Context, req *QuerySolanaCountersRequest) (*QuerySolanaCountersResponse, error) {
...
func _Query_SolanaCounters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.validation.Query/SolanaCounters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryBackfillRequestsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryBackfillRequestsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryBackfillRequestsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryBackfillRequestsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryBackfillRequestsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryBackfillRequestsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.BackfillRequests != nil {
		{
			size, err := m.BackfillRequests.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *QuerySolanaCountersRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QuerySolanaCountersRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QuerySolanaCountersRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QuerySolanaCountersResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QuerySolanaCountersResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QuerySolanaCountersResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryBackfillRequestsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryBackfillRequestsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.BackfillRequests != nil {
		l = m.BackfillRequests.Size()
		n += 1 + l + sovQuery(uint64(l))
	}
	return n
}

func (m *QuerySolanaCountersRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QuerySolanaCountersResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryBackfillRequestsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryBackfillRequestsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryBackfillRequestsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryBackfillRequestsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryBackfillRequestsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryBackfillRequestsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.BackfillRequests == nil {
				m.BackfillRequests = &BackfillRequests{}
			}
			if err := m.BackfillRequests.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QuerySolanaCountersRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QuerySolanaCountersRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QuerySolanaCountersRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QuerySolanaCountersResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QuerySolanaCountersResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QuerySolanaCountersResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Counters == nil {
				m.Counters = make(map[string]*SolanaCounters)
			}
			var mapkey string
