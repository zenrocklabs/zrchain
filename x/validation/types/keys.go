...
var (
	...
	//
	// The next available key currently is 111.
	// ====================================================================================================
	...
	ProcessedSolanaMintEventsKey       = collections.NewPrefix(110)
)
var (
...
var (
	...
	ProcessedSolanaMintEventsIndex         = "processed_solana_mint_events"
)
...
// VALUE: validator operator address ([]byte)
func GetValidatorsByPowerIndexKey(validator ValidatorHV, powerReduction math.Int, valAc addresscodec.Codec) []byte {
	// NOTE the address doesn't need to be stored because counter bytes must always be different
	// NOTE the larger values are of higher value

	consensusPower := sdk.TokensToConsensusPower(validator.TokensNative, powerReduction)
