...
import (
	...
	types1 "github.com/Zenrock-Foundation/zrchain/v6/x/dct/types"
...
type GenesisState struct {
	...
	ZcashBlockHeaders map[int64]api.BTCBlockHeader `protobuf:"bytes,31,rep,name=zcash_block_headers,json=zcashBlockHeaders,proto3" json:"zcash_block_headers" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// requested_historical_zcash_headers defines the requested historical ZCash headers at genesis.
	RequestedHistoricalZcashHeaders types1.RequestedZcashHeaders `protobuf:"bytes,32,opt,name=requested_historical_zcash_headers,json=requestedHistoricalZcashHeaders,proto3" json:"requested_historical_zcash_headers"`
...
func (m *GenesisState) GetZcashBlockHeaders() map[int64]api.BTCBlockHeader {
	if m != nil {
		return m.ZcashBlockHeaders
	}
	return nil
}

func (m *GenesisState) GetRequestedHistoricalZcashHeaders() types1.RequestedZcashHeaders {
	if m != nil {
		return m.RequestedHistoricalZcashHeaders
	}
	return types1.RequestedZcashHeaders{}
}

func (m *GenesisState) GetLatestZcashHeaderHeight() int64 {
	if m != nil {
		return m.LatestZcashHeaderHeight
	}
	return 0
}
...
func init() {
	...
	proto.RegisterMapType((map[int64]api.BTCBlockHeader)(nil), "zrchain.validation.GenesisState.ZcashBlockHeadersEntry")
...
var fileDescriptor_c682c41018a13c0f = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.LatestZcashHeaderHeight != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.LatestZcashHeaderHeight))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x88
	...
	{
		size, err := m.RequestedHistoricalZcashHeaders.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	i--
	dAtA[i] = 0x82
	if len(m.ZcashBlockHeaders) > 0 {
		for k := range m.ZcashBlockHeaders {
			v := m.ZcashBlockHeaders[k]
			baseI := i
			{
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.ZcashBlockHeaders) > 0 {
		for k, v := range m.ZcashBlockHeaders {
			_ = k
			_ = v
			l = v.Size()
			mapEntrySize := 1 + sovGenesis(uint64(k)) + 1 + l + sovGenesis(uint64(l))
	...
	l = m.RequestedHistoricalZcashHeaders.Size()
	n += 2 + l + sovGenesis(uint64(l))
	if m.LatestZcashHeaderHeight != 0 {
		n += 2 + sovGenesis(uint64(m.LatestZcashHeaderHeight))
	}
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ZcashBlockHeaders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ZcashBlockHeaders == nil {
				m.ZcashBlockHeaders = make(map[int64]api.BTCBlockHeader)
			}
			var mapkey int64
			mapvalue := &api.BTCBlockHeader{}
			for iNdEx < postIndex {
			...
			m.ZcashBlockHeaders[mapkey] = *mapvalue
			iNdEx = postIndex
		case 32:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestedHistoricalZcashHeaders", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.RequestedHistoricalZcashHeaders.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 33:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatestZcashHeaderHeight", wireType)
			}
			m.LatestZcashHeaderHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowGenesis
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LatestZcashHeaderHeight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
