...
var (
	...
	pattern_Query_QueryBackfillRequests_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"cosmos", "validation", "v1beta1", "backfill_requests"}, "", runtime.AssumeColonVerbOpt(false)))
)
