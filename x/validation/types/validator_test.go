...
func TestValidatorsSortDeterminism(t *testing.T) {
	...
	// Save sorted copy
	sort.Sort(types.Validators{Validators: vals, ValidatorCodec: address.NewBech32Codec("zenvaloper")})
	...
	for i := 0; i < 10; i++ {
		...
		types.Validators{Validators: vals, ValidatorCodec: address.NewBech32Codec("zenvaloper")}.Sort()
...
func TestValidatorsSortCometBFT(t *testing.T) {
	...
	valz := types.Validators{Validators: vals, ValidatorCodec: address.NewBech32Codec("zenvaloper")}
