...
import (
	...
	policymodule "github.com/Zenrock-Foundation/zrchain/v6/x/policy/module"
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				workspace: &defaultWs,
				key:       &keyWithPolicy,
				msg:       types.NewMsgNewSignTransactionRequest("testOwner", []uint64{1}, types.WalletType_WALLET_TYPE_EVM, unsignedTx1, metadataAny, 1000),
			},
			wantSignTxRequest: &types.SignTransactionRequest{
				Id:                  1,
				Creator:             "testOwner",
		...
		},
		{
			...
			args: args{
				...
				workspace: &defaultWs,
				key:       &defaultKey,
				msg:       types.NewMsgNewSignTransactionRequest("testOwner", []uint64{5}, types.WalletType_WALLET_TYPE_EVM, unsignedTx1, metadataAny, 1000),
			},
			wantErr: true,
		},
		{
		...
		},
		{
			...
			args: args{
				...
				workspace: &defaultWs,
				key:       &defaultKey,
				msg:       types.NewMsgNewSignTransactionRequest("testOwner", []uint64{1}, types.WalletType_WALLET_TYPE_UNSPECIFIED, unsignedTx1, metadataAny, 1000),
			},
			wantErr: true,
		},
		{
			...
			args: args{
				...
				workspace: &defaultWs,
				key:       &defaultKey,
				msg:       types.NewMsgNewSignTransactionRequest("testOwner", []uint64{1}, types.WalletType_WALLET_TYPE_NATIVE, unsignedCosmosTx, nil, 1000),
			},
			wantSignTxRequest: &types.SignTransactionRequest{
				Id:                  1,
				Creator:             "testOwner",
		...
		},
		{
			...
			args: args{
				...
				workspace: &defaultWs,
				key:       &defaultKey,
				msg:       types.NewMsgNewSignTransactionRequest("testOwner", []uint64{1}, types.WalletType_WALLET_TYPE_EVM, unsignedTx1, nil, 1000),
			},
			wantErr: true,
		},
		{
			...
			args: args{
				...
				workspace: &defaultWs,
				key:       &defaultKey,
				msg:       types.NewMsgNewSignTransactionRequest("testOwner", []uint64{1}, types.WalletType_WALLET_TYPE_EVM, unsignedTx1, failMetadataAny, 1000),
			},
			wantErr: true,
		},
		{
