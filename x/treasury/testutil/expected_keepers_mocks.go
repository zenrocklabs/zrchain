...
func (m *MockIdentityKeeper) GetKeyring(ctx types2.Context, addr string) *types.Keyring {
	m.ctrl.T.Helper()
...
func (m *MockIdentityKeeper) GetWorkspace(ctx types2.Context, addr string) *types.Workspace {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetWorkspace", ctx, addr)
	ret0, _ := ret[0].(*types.Workspace)
	return ret0
}

// GetWorkspace indicates an expected call of GetWorkspace.
func (mr *MockIdentityKeeperMockRecorder) GetWorkspace(ctx, addr interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetWorkspace", reflect.TypeOf((*MockIdentityKeeper)(nil).GetWorkspace), ctx, addr)
}

// GetZrSignWorkspace mocks base method.
func (m *MockIdentityKeeper) GetZrSignWorkspace(goCtx context.Context, ethAddress, walletType string) (string, error) {
	m.ctrl.T.Helper()
