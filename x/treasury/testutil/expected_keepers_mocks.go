...
//
//	mockgen -source=x/treasury/types/expected_keepers.go -destination=x/treasury/testutil/expected_keepers_mocks.go -package=testutil
//
...
func (mr *MockIdentityKeeperMockRecorder) GetKeyring(ctx, addr any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIdentityKeeperMockRecorder) GetZrSignWorkspace(goCtx, ethAddress, walletType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIdentityKeeperMockRecorder) GetZrSignWorkspaces(goCtx, ethAddress, walletType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) ActionHandler(actionType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) AddAction(ctx, creator, msg, policyID, btl, policyData, wsOwners any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) GeneratorHandler(reqType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) GetPolicy(ctx, policyId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) GetPolicyParticipants(ctx, policyId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) PolicyForAction(ctx, act any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) PolicyMembersAreOwners(ctx, policyId, wsOwners any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) RegisterActionHandler(actionType, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) RegisterPolicyGeneratorHandler(reqType, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) SetAction(ctx, action any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPolicyKeeperMockRecorder) Unpack(policyPb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) GetNonceAccountKey(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockZentpKeeperMockRecorder) GetNonceAuthorityKey(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// UpdateDctStatusToKeysCreated mocks base method.
func (m *MockZentpKeeper) UpdateDctStatusToKeysCreated(ctx context.Context, keyRequestId uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateDctStatusToKeysCreated", ctx, keyRequestId)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateDctStatusToKeysCreated indicates an expected call of UpdateDctStatusToKeysCreated.
func (mr *MockZentpKeeperMockRecorder) UpdateDctStatusToKeysCreated(ctx, keyRequestId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateDctStatusToKeysCreated", reflect.TypeOf((*MockZentpKeeper)(nil).UpdateDctStatusToKeysCreated), ctx, keyRequestId)
}
