...
type QueryDctWalletsRequest struct {
	AssetType     types.Asset        `protobuf:"varint,1,opt,name=asset_type,json=assetType,proto3,enum=zrchain.dct.Asset" json:"asset_type,omitempty"`
	WalletType    WalletType         `protobuf:"varint,2,opt,name=wallet_type,json=walletType,proto3,enum=zrchain.treasury.WalletType" json:"wallet_type,omitempty"`
	MintChainId   string             `protobuf:"bytes,3,opt,name=mint_chain_id,json=mintChainId,proto3" json:"mint_chain_id,omitempty"`
	RecipientAddr string             `protobuf:"bytes,4,opt,name=recipient_addr,json=recipientAddr,proto3" json:"recipient_addr,omitempty"`
	Pagination    *query.PageRequest `protobuf:"bytes,5,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryDctWalletsRequest) Reset()         { *m = QueryDctWalletsRequest{} }
func (m *QueryDctWalletsRequest) String() string { return proto.CompactTextString(m) }
...
func (m *QueryDctWalletsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDctWalletsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDctWalletsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDctWalletsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDctWalletsRequest.Merge(m, src)
}
func (m *QueryDctWalletsRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryDctWalletsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDctWalletsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDctWalletsRequest proto.InternalMessageInfo

func (m *QueryDctWalletsRequest) GetAssetType() types.Asset {
	if m != nil {
		return m.AssetType
	}
	return types.Asset_ASSET_UNSPECIFIED
}

func (m *QueryDctWalletsRequest) GetWalletType() WalletType {
	if m != nil {
		return m.WalletType
	}
	return WalletType_WALLET_TYPE_UNSPECIFIED
...
func (m *QueryDctWalletsRequest) GetMintChainId() string {
	if m != nil {
		return m.MintChainId
	}
	return ""
...
func (m *QueryDctWalletsRequest) GetRecipientAddr() string {
	if m != nil {
		return m.RecipientAddr
	}
	return ""
...
func (m *QueryDctWalletsRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *QueryDctWalletsResponse) Reset()         { *m = QueryDctWalletsResponse{} }
func (m *QueryDctWalletsResponse) String() string { return proto.CompactTextString(m) }
...
func (m *QueryDctWalletsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryDctWalletsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryDctWalletsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryDctWalletsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryDctWalletsResponse.Merge(m, src)
}
func (m *QueryDctWalletsResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryDctWalletsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryDctWalletsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryDctWalletsResponse proto.InternalMessageInfo

func (m *QueryDctWalletsResponse) GetDctWallets() []*KeyAndWalletResponse {
	if m != nil {
		return m.DctWallets
	}
	return nil
...
func (m *QueryDctWalletsResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryDctWalletsRequest)(nil), "zrchain.treasury.QueryDctWalletsRequest")
	proto.RegisterType((*QueryDctWalletsResponse)(nil), "zrchain.treasury.QueryDctWalletsResponse")
}
...
var fileDescriptor_5eb79c12b3405d66 = []byte{
	...
	,
}
...
func (c *queryClient) DctWallets(ctx context.Context, in *QueryDctWalletsRequest, opts ...grpc.CallOption) (*QueryDctWalletsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/zrchain.treasury.Query/DctWallets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) DctWallets(ctx context.Context, req *QueryDctWalletsRequest) (*QueryDctWalletsResponse, error) {
...
func _Query_DctWallets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/zrchain.treasury.Query/DctWallets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryDctWalletsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDctWalletsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDctWalletsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryDctWalletsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryDctWalletsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryDctWalletsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.DctWallets) > 0 {
		for iNdEx := len(m.DctWallets) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DctWallets[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryDctWalletsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDctWalletsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryDctWalletsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDctWalletsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDctWalletsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AssetType |= types.Asset(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *QueryDctWalletsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryDctWalletsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryDctWalletsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DctWallets", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DctWallets = append(m.DctWallets, &KeyAndWalletResponse{})
			if err := m.DctWallets[len(m.DctWallets)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
