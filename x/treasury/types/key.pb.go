...
func (m *PartySignature) Reset()         { *m = PartySignature{} }
func (m *PartySignature) String() string { return proto.CompactTextString(m) }
func (*PartySignature) ProtoMessage()    {}
func (*PartySignature) Descriptor() ([]byte, []int) {
	return fileDescriptor_4fe3d9b67a5056f9, []int{0}
}
func (m *PartySignature) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PartySignature) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PartySignature.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *PartySignature) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PartySignature.Merge(m, src)
}
func (m *PartySignature) XXX_Size() int {
	return m.Size()
}
func (m *PartySignature) XXX_DiscardUnknown() {
	xxx_messageInfo_PartySignature.DiscardUnknown(m)
}

var xxx_messageInfo_PartySignature proto.InternalMessageInfo

func (m *PartySignature) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *PartySignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
type KeyRequest struct {
	...
	KeyringPartySignatures [][]byte          `protobuf:"bytes,7,rep,name=keyring_party_signatures,json=keyringPartySignatures,proto3" json:"keyring_party_signatures,omitempty"` // Deprecated: Do not use.
...
func (m *KeyRequest) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
func (m *KeyRequest) GetKeyringPartySigs() []*PartySignature {
	if m != nil {
...
func (m *KeyReqResponse) GetKeyringPartySignatures() []*PartySignature {
	if m != nil {
		return m.KeyringPartySignatures
	}
	return nil
...
func (m *KeyReqResponse) GetPublicKey() []byte {
	if m != nil {
		return m.PublicKey
	}
	return nil
...
type ZenBTCMetadata struct {
	...
	Asset         types.Asset `protobuf:"varint,6,opt,name=asset,proto3,enum=zrchain.dct.Asset" json:"asset,omitempty"`
}
...
func (m *ZenBTCMetadata) GetAsset() types.Asset {
	if m != nil {
		return m.Asset
	}
...
func init() {
	...
	proto.RegisterType((*PartySignature)(nil), "zrchain.treasury.PartySignature")
...
var fileDescriptor_4fe3d9b67a5056f9 = []byte{
	...
	,
}

func (m *PartySignature) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *PartySignature) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PartySignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Signature) > 0 {
		...
		i = encodeVarintKey(dAtA, i, uint64(len(m.Signature)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
...
func (m *ZenBTCMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Asset != 0 {
		i = encodeVarintKey(dAtA, i, uint64(m.Asset))
		i--
		dAtA[i] = 0x30
	}
...
func (m *PartySignature) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PartySignature) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: PartySignature: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PartySignature: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
