...
replace (
	...
	github.com/zenrocklabs/zenrock-avs => github.com/zenrocklabs/zenrock-avs v1.1.2
)
...
require (
	...
	github.com/zenrocklabs/zenbtc v1.0.1
...
require (
	...
	github.com/zenrocklabs/zenrock/tools/go-client v1.1.1 // indirect
